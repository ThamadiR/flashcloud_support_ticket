//#region node_modules/flowbite/lib/esm/dom/events.js
var Events = function() {
...
//#endregion
//#region node_modules/flowbite/lib/esm/dom/instances.js
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/accordion/index.js
...
var Accordion = function() {
	function Accordion(accordionEl, items, options, instanceOptions) {
		...
		if (options === void 0) options = Default$13;
		if (instanceOptions === void 0) instanceOptions = DefaultInstanceOptions$13;
		this._instanceId = instanceOptions.id ? instanceOptions.id : accordionEl.id;
		this._accordionEl = accordionEl;
		this._items = items;
		this._options = __assign$13(__assign$13({}, Default$13), options);
...
function initAccordions() {
	document.querySelectorAll("[data-accordion]").forEach(function($accordionEl) {
		...
		new Accordion($accordionEl, items, {
			...
			activeClasses: activeClasses ? activeClasses : Default$13.activeClasses,
			inactiveClasses: inactiveClasses ? inactiveClasses : Default$13.inactiveClasses
		});
	});
}
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/collapse/index.js
...
var Collapse = function() {
	function Collapse(targetEl, triggerEl, options, instanceOptions) {
		...
		if (options === void 0) options = Default$12;
		if (instanceOptions === void 0) instanceOptions = DefaultInstanceOptions$12;
		this._instanceId = instanceOptions.id ? instanceOptions.id : targetEl.id;
		this._targetEl = targetEl;
		this._triggerEl = triggerEl;
		this._options = __assign$12(__assign$12({}, Default$12), options);
		this._visible = false;
		this._initialized = false;
		this.init();
	...
	Collapse.prototype.init = function() {
		...
		if (this._triggerEl && this._targetEl && !this._initialized) {
			...
			else this._visible = !this._targetEl.classList.contains("hidden");
...
function initCollapses() {
	document.querySelectorAll("[data-collapse-toggle]").forEach(function($triggerEl) {
		...
		if ($targetEl) if (!instances.instanceExists("Collapse", $targetEl.getAttribute("id"))) new Collapse($targetEl, $triggerEl);
		else new Collapse($targetEl, $triggerEl, {}, { id: $targetEl.getAttribute("id") + "_" + instances._generateRandomId() });
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/carousel/index.js
...
var Carousel = function() {
	function Carousel(carouselEl, items, options, instanceOptions) {
		...
		if (items === void 0) items = [];
		if (options === void 0) options = Default$11;
		if (instanceOptions === void 0) instanceOptions = DefaultInstanceOptions$11;
		this._instanceId = instanceOptions.id ? instanceOptions.id : carouselEl.id;
		this._carouselEl = carouselEl;
		this._items = items;
		this._options = __assign$11(__assign$11(__assign$11({}, Default$11), options), { indicators: __assign$11(__assign$11({}, Default$11.indicators), options.indicators) });
...
function initCarousels() {
	document.querySelectorAll("[data-carousel]").forEach(function($carouselEl) {
		...
		var carousel = new Carousel($carouselEl, items, {
			...
			interval: interval ? interval : Default$11.interval
		});
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/dismiss/index.js
...
var Dismiss = function() {
	function Dismiss(targetEl, triggerEl, options, instanceOptions) {
		if (targetEl === void 0) targetEl = null;
		if (triggerEl === void 0) triggerEl = null;
		if (options === void 0) options = Default$10;
		if (instanceOptions === void 0) instanceOptions = DefaultInstanceOptions$10;
		this._instanceId = instanceOptions.id ? instanceOptions.id : targetEl.id;
		this._targetEl = targetEl;
		this._triggerEl = triggerEl;
		this._options = __assign$10(__assign$10({}, Default$10), options);
		this._initialized = false;
		this.init();
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/dropdown/index.js
...
var Dropdown = function() {
	...
	Dropdown.prototype._handleClickOutside = function(ev, targetEl) {
		...
		var isIgnored = false;
		if (ignoreClickOutsideClass) document.querySelectorAll(".".concat(ignoreClickOutsideClass)).forEach(function(el) {
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/modal/index.js
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/drawer/index.js
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/tabs/index.js
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/tooltip/index.js
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/popover/index.js
	...
	document.querySelectorAll("[data-popover-target]").forEach(function($triggerEl) {
		...
		if ($popoverEl) {
			...
			new Popover($popoverEl, $triggerEl, {
				...
				offset: offset ? parseInt(offset) : Default$4.offset,
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/dial/index.js
	...
	document.querySelectorAll("[data-dial-init]").forEach(function($parentEl) {
		...
		if ($triggerEl) {
			...
			if ($dialEl) {
				...
				new Dial($parentEl, $triggerEl, $dialEl, { triggerType: triggerType ? triggerType : Default$3.triggerType });
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/input-counter/index.js
...
function initInputCounters() {
	document.querySelectorAll("[data-input-counter]").forEach(function($targetEl) {
		...
		if ($targetEl) {
			if (!instances.instanceExists("InputCounter", $targetEl.getAttribute("id"))) new InputCounter($targetEl, $incrementEl ? $incrementEl : null, $decrementEl ? $decrementEl : null, {
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/clipboard/index.js
...
function initCopyClipboards() {
	document.querySelectorAll("[data-copy-to-clipboard-target]").forEach(function($triggerEl) {
		...
		if ($targetEl) {
			if (!instances.instanceExists("CopyClipboard", $targetEl.getAttribute("id"))) new CopyClipboard($triggerEl, $targetEl, {
...
//#endregion
//#region node_modules/flowbite-datepicker/dist/main.esm.js
...
function isInRange(testVal, min, max) {
	return (min === void 0 || testVal >= min) && (max === void 0 || testVal <= max);
}
...
function dateValue() {
	switch (arguments.length) {
		case 0: return today();
		case 1: return stripTime(arguments.length <= 0 ? void 0 : arguments[0]);
	}
...
function findFromPath(path, criteria, currentTarget) {
	...
	else if (el === currentTarget || !el.parentElement) return;
...
function processOptions(options, datepicker) {
	...
	if (inOpts.language) {
		var lang;
		if (inOpts.language !== language) if (locales[inOpts.language]) lang = inOpts.language;
		else {
	...
	if (inOpts.todayBtnMode !== void 0) {
		switch (inOpts.todayBtnMode) {
			case 0:
			case 1: config.todayBtnMode = inOpts.todayBtnMode;
		}
		...
		value: function performBeforeHook(el, current, timeValue) {
			...
			switch (_typeof(result)) {
				case "boolean":
					...
					break;
				case "string": result = { classes: result };
			}
			if (result) {
	...
	return _createClass(DaysView, [
		{
			key: "init",
			value: function init(options) {
				if (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true) {
		...
		},
		{
			...
			value: function refresh() {
				var _this3 = this;
				var _ref2 = _slicedToArray(this.range || [], 2), rangeStart = _ref2[0], rangeEnd = _ref2[1];
	...
	return _createClass(MonthsView, [
		{
			...
			value: function init(options) {
				if (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true) {
					...
					this.grid.appendChild(parseHTML(createTagRepeat("span", 12, { "data-month": function dataMonth(ix) {
						return ix;
					} })));
				}
		...
		},
		{
			...
			value: function setOptions(options) {
				...
				if (hasProperty(options, "minDate")) if (options.minDate === void 0) this.minYear = this.minMonth = this.minDate = void 0;
				else {
				...
				if (hasProperty(options, "maxDate")) if (options.maxDate === void 0) this.maxYear = this.maxMonth = this.maxDate = void 0;
				else {
		...
		},
		{
			...
			value: function updateSelection() {
				...
				this.selected = dates.reduce(function(selected, timeValue) {
					...
					if (selected[year] === void 0) selected[year] = [month];
		...
		},
		{
			...
			value: function refresh() {
				var _this2 = this;
				var selected = this.selected[this.year] || [];
				var _ref2 = _slicedToArray(computeMonthRange(this.range, this.year) || [], 2), rangeStart = _ref2[0], rangeEnd = _ref2[1];
				this.grid.querySelectorAll(".range, .range-start, .range-end, .selected, .focused").forEach(function(el) {
...
var YearsView = /* @__PURE__ */ function(_View) {
	...
	return _createClass(YearsView, [
		...
		},
		{
			key: "setOptions",
			value: function setOptions(options) {
				if (hasProperty(options, "minDate")) if (options.minDate === void 0) this.minYear = this.minDate = void 0;
				else {
					this.minYear = startOfYearPeriod(options.minDate, this.step);
					this.minDate = dateValue(this.minYear, 0, 1);
				}
				if (hasProperty(options, "maxDate")) if (options.maxDate === void 0) this.maxYear = this.maxDate = void 0;
				else {
...
function goToPrevOrNext(datepicker, direction) {
	...
	switch (currentView.id) {
		...
		case 1:
			...
			break;
		default: newViewDate = addYears(viewDate, direction * currentView.navStep);
	}
...
function unfocus(datepicker) {
	if (datepicker.config.updateOnBlur) datepicker.update({ autohide: true });
	else {
...
function onClickView(datepicker, ev) {
	...
	var _datepicker$picker$cu = datepicker.picker.currentView, id = _datepicker$picker$cu.id;
	if (_datepicker$picker$cu.isMinView) datepicker.setDate(Number(target.dataset.date));
...
function processPickerOptions(picker, options) {
	...
	if (options.todayBtn !== void 0) if (options.todayBtn) showElement(picker.controls.todayBtn);
	else hideElement(picker.controls.todayBtn);
	if (hasProperty(options, "minDate") || hasProperty(options, "maxDate")) {
		var _picker$datepicker$co = picker.datepicker.config, minDate = _picker$datepicker$co.minDate, maxDate = _picker$datepicker$co.maxDate;
		picker.controls.todayBtn.disabled = !isInRange(today(), minDate, maxDate);
	}
	if (options.clearBtn !== void 0) if (options.clearBtn) showElement(picker.controls.clearBtn);
	else hideElement(picker.controls.clearBtn);
}
function computeResetViewDate(datepicker) {
	var dates = datepicker.dates, config = datepicker.config;
	return limitToRange(dates.length > 0 ? lastItemOf(dates) : config.defaultViewDate, config.minDate, config.maxDate);
}
function setViewDate(picker, newDate) {
	...
	switch (id) {
		case 0: return newDate < first || newDate > last;
		case 1: return viewYear !== year;
		default: return viewYear < first || viewYear > last;
	}
}
...
var Picker = /* @__PURE__ */ function() {
	...
	return _createClass(Picker, [
		...
		},
		{
			...
			value: function place() {
				...
				if (orientX === "auto") if (left < 0) {
					orientX = "left";
					left = 10;
				} else if (left + calendarWidth > containerWidth) orientX = "right";
		...
		},
		{
			key: "render",
			value: function render() {
				var renderMethod = (arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true) && this._renderMethod || "render";
...
function findNextAvailableOne(date, addFn, increase, testFn, min, max) {
	...
	if (testFn(date)) return findNextAvailableOne(addFn(date, increase), addFn, increase, testFn, min, max);
	return date;
}
...
function _setDate(datepicker, inputDates, options) {
	...
	else if (autohide === void 0) autohide = datepicker.config.autohide;
	...
	*/
	function Datepicker(element) {
		...
		if (rangepicker) {
			...
			Object.defineProperty(this, "rangepicker", { get: function get() {
				return rangepicker;
			} });
		}
		this.dates = [];
...
var DateRangePicker = /* @__PURE__ */ function() {
	...
	*/
	function DateRangePicker(element) {
		...
		var datepickers = [];
		Object.defineProperty(this, "datepickers", { get: function get() {
			return datepickers;
		} });
		setupDatepicker(this, changeDateListener, this.inputs[0], cleanOptions);
		setupDatepicker(this, changeDateListener, this.inputs[1], cleanOptions);
		Object.freeze(datepickers);
		if (datepickers[0].dates.length > 0) onChangeDate(this, { target: this.inputs[0] });
		else if (datepickers[1].dates.length > 0) onChangeDate(this, { target: this.inputs[1] });
	}
	/**
	...
	return _createClass(DateRangePicker, [
		...
		},
		{
			...
			value: function setDates(rangeStart, rangeEnd) {
				...
				if (datepicker1.dates[0] !== origDates[1]) onChangeDate(this, { target: this.inputs[1] });
				else if (datepicker0.dates[0] !== origDates[0]) onChangeDate(this, { target: this.inputs[0] });
			}
		}
	]);
}();
//#endregion
//#region node_modules/flowbite/lib/esm/components/datepicker/index.js
...
var Datepicker = function() {
	...
	Datepicker.prototype.init = function() {
		if (this._datepickerEl && !this._initialized) {
			if (this._options.rangePicker) this._datepickerInstance = new DateRangePicker(this._datepickerEl, this._getDatepickerOptions(this._options));
			else this._datepickerInstance = new Datepicker$1(this._datepickerEl, this._getDatepickerOptions(this._options));
			this._initialized = true;
		}
	};
	...
	Datepicker.prototype.getDate = function() {
		...
		if (!this._options.rangePicker && this._datepickerInstance instanceof Datepicker$1) return this._datepickerInstance.getDate();
	};
	Datepicker.prototype.setDate = function(date) {
		...
		if (!this._options.rangePicker && this._datepickerInstance instanceof Datepicker$1) return this._datepickerInstance.setDate(date);
	};
...
//#endregion
//#region node_modules/flowbite/lib/esm/components/index.js
...
//#endregion
//#region node_modules/flowbite/lib/esm/index.js
new Events("load", [
	initAccordions,
	initCollapses,
	initCarousels,
...
//#endregion
export { Accordion, Carousel, Collapse, CopyClipboard, Datepicker, Dial, Dismiss, Drawer, Dropdown, InputCounter, Modal, Popover, Tabs, Tooltip, initAccordions, initCarousels, initCollapses, initCopyClipboards, initDatepickers, initDials, initDismisses, initDrawers, initDropdowns, initFlowbite, initInputCounters, initModals, initPopovers, initTabs, initTooltips };
