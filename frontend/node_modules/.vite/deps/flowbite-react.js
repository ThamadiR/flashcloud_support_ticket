...
import { _ as isShadowRoot, a as flip$1, c as getComputedStyle$1, d as getParentNode, f as getWindow, g as isNode, h as isLastTraversableNode, i as computePosition, l as getNodeName, m as isHTMLElement, n as autoPlacement$1, o as offset$1, p as isElement, r as autoUpdate, s as shift$1, t as arrow$2, u as getOverflowAncestors, v as isWebKit, y as floor } from "./floating-ui.dom-klNg6s26.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
//#region node_modules/flowbite-react/dist/helpers/get.js
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/without-theming-props.js
function withoutThemingProps(props) {
	const { theme, clearTheme, applyTheme, ...rest } = props;
	return rest;
}
//#endregion
//#region node_modules/flowbite-react/dist/helpers/resolve-props.js
function resolveProps(props, providerProps) {
	let mergedProps = withoutThemingProps(props);
	if (providerProps) mergedProps = {
		...providerProps,
		...props
	};
	return mergedProps;
...
//#endregion
//#region node_modules/deepmerge-ts/dist/index.mjs
/**
...
function mergeRecords$1(values, utils, meta) {
	...
	for (const key of getKeys(values)) {
		...
		const propertyResult = mergeUnknowns(propValues, utils, utils.metaDataUpdater(meta, {
			key,
			parents: values
		}));
...
//#endregion
//#region node_modules/flowbite-react/dist/store/index.js
var store = {
	dark: void 0,
	mode: void 0,
	prefix: void 0,
...
function setStore(data) {
	if ("dark" in data) store.dark = data.dark;
	if ("mode" in data) if ([
		"light",
		"dark",
		"auto"
	].includes(data.mode)) store.mode = data.mode;
	else console.warn(`Invalid mode value: ${data.mode}.
Available values: light, dark, auto`);
	if ("prefix" in data) store.prefix = data.prefix;
	if ("version" in data) if (data.version === 3 || data.version === 4) store.version = data.version;
	else console.warn(`Invalid version value: ${data.version}.
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/apply-prefix.js
var cache$4 = /* @__PURE__ */ new Map();
function applyPrefix(classNames, prefix) {
	if (!classNames.trim().length || !prefix.trim().length) return classNames;
	...
	const result = classNames.split(/\s+/).map((className) => {
		...
		if (!className.length || className.startsWith(prefix)) return className;
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/apply-prefix-v3.js
...
function applyPrefixV3(classNames, prefix, separator = ":") {
	...
	const result = classNames.split(/\s+/).map((className) => {
		...
		if (className.startsWith("[") && className.endsWith("]")) return className;
		const parts = className.split(separator);
		let prefixedBaseClass = parts.pop() ?? "";
		let modifiers = "";
		...
		if (prefixedBaseClass.startsWith(prefix)) return className;
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/convert-utilities-to-v4.js
var cache$2 = /* @__PURE__ */ new Map();
function convertUtilitiesToV4(classNames) {
	if (!classNames.trim().length) return classNames;
	const cacheKey = classNames;
	const cacheValue = cache$2.get(cacheKey);
	if (cacheValue) return cacheValue;
	const result = classNames.split(/(\s+)/).map((part) => {
		if (/^\s+$/.test(part)) return part;
		const processed = part;
		const modifierMatch = processed.match(/^([^:]+:)?(.+)$/);
		if (modifierMatch) {
			const [, modifier = "", baseClass] = modifierMatch;
			for (const [regex, replacement] of regexMap) if (regex.test(baseClass)) return modifier + baseClass.replace(regex, replacement);
		}
		return processed;
	}).join("");
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/deep-merge.js
function deepMergeStrings(merge) {
	return deepmergeCustom({ mergeOthers: (values, utils) => {
		if (values.some((value) => typeof value === "string")) {
			...
			for (const string of strings) {
				...
				for (const part of parts) stringMap.add(part);
			}
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/is-equal.js
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/strip-dark.js
var cache$1 = /* @__PURE__ */ new Map();
function stripDark(classNames) {
	if (classNames === void 0 || classNames === null) return classNames;
	if (!classNames.trim().length) return classNames;
	classNames = classNames.trim();
	const cacheKey = classNames;
...
//#endregion
//#region node_modules/tailwind-merge-v2/dist/bundle-mjs.mjs
...
var getGroupRecursive$1 = (classParts, classPartObject) => {
...
var isThemeGetter$1 = (func) => func.isThemeGetter;
...
var createLruCache$1 = (maxCacheSize) => {
...
var createParseClassName$1 = (config) => {
...
var SPLIT_CLASSES_REGEX$1 = /\s+/;
var mergeClassList$1 = (classList, configUtils) => {
...
var arbitraryValueRegex$1 = /^\[(?:([a-z-]+):)?(.+)\]$/i;
var fractionRegex$1 = /^\d+\/\d+$/;
...
var isLength = (value) => isNumber$1(value) || stringLengths.has(value) || fractionRegex$1.test(value);
var isArbitraryLength$1 = (value) => getIsArbitraryValue$1(value, "length", isLengthOnly$1);
var isNumber$1 = (value) => Boolean(value) && !Number.isNaN(Number(value));
var isArbitraryNumber$1 = (value) => getIsArbitraryValue$1(value, "number", isNumber$1);
var isInteger$1 = (value) => Boolean(value) && Number.isInteger(Number(value));
...
var isArbitrarySize$1 = (value) => getIsArbitraryValue$1(value, sizeLabels, isNever$1);
var isArbitraryPosition$1 = (value) => getIsArbitraryValue$1(value, "position", isNever$1);
var imageLabels = /* @__PURE__ */ new Set(["image", "url"]);
var isArbitraryImage$1 = (value) => getIsArbitraryValue$1(value, imageLabels, isImage$1);
var isArbitraryShadow$1 = (value) => getIsArbitraryValue$1(value, "", isShadow$1);
var isAny$1 = () => true;
var getIsArbitraryValue$1 = (value, label, testValue) => {
...
var isLengthOnly$1 = (value) => lengthUnitRegex$1.test(value) && !colorFunctionRegex$1.test(value);
var isNever$1 = () => false;
...
var getDefaultConfig$1 = () => {
	...
	return {
		...
		classGroups: {
			...
			*/
			columns: [{ columns: [isTshirtSize$1] }],
			/**
			* Break After
			...
			*/
			"object-position": [{ object: [...getPositions(), isArbitraryValue$1] }],
			/**
			* Overflow
			...
			*/
			"list-image": [{ "list-image": ["none", isArbitraryValue$1] }],
			/**
			* List Style Type
			...
			*/
			content: [{ content: ["none", isArbitraryValue$1] }],
			/**
			...
			*/
			"bg-position": [{ bg: [...getPositions(), isArbitraryPosition$1] }],
			/**
			* Background Repeat
			...
			*/
			"outline-offset": [{ "outline-offset": [isLength, isArbitraryValue$1] }],
			/**
			* Outline Width
			* @see https://tailwindcss.com/docs/outline-width
			*/
			"outline-w": [{ outline: [isLength, isArbitraryLength$1] }],
			/**
			* Outline Color
			...
			*/
			"ring-offset-w": [{ "ring-offset": [isLength, isArbitraryLength$1] }],
			/**
			* Ring Offset Color
			...
			*/
			rotate: [{ rotate: [isInteger$1, isArbitraryValue$1] }],
			/**
			* Translate X
...
*/
var mergeConfigs$1 = (baseConfig, { cacheSize, prefix, separator, experimentalParseClassName, extend = {}, override = {} }) => {
	...
	for (const configKey in override) overrideConfigProperties$1(baseConfig[configKey], override[configKey]);
	for (const key in extend) mergeConfigProperties$1(baseConfig[key], extend[key]);
	return baseConfig;
};
var overrideProperty$1 = (baseObject, overrideKey, overrideValue) => {
	if (overrideValue !== void 0) baseObject[overrideKey] = overrideValue;
};
var overrideConfigProperties$1 = (baseObject, overrideObject) => {
	if (overrideObject) for (const key in overrideObject) overrideProperty$1(baseObject, key, overrideObject[key]);
};
var mergeConfigProperties$1 = (baseObject, mergeObject) => {
	if (mergeObject) for (const key in mergeObject) {
		const mergeValue = mergeObject[key];
		if (mergeValue !== void 0) baseObject[key] = (baseObject[key] || []).concat(mergeValue);
	}
};
var extendTailwindMerge$1 = (configExtension, ...createConfig) => typeof configExtension === "function" ? createTailwindMerge$1(getDefaultConfig$1, configExtension, ...createConfig) : createTailwindMerge$1(() => mergeConfigs$1(getDefaultConfig$1(), configExtension), ...createConfig);
//#endregion
//#region node_modules/tailwind-merge-v3/dist/bundle-mjs.mjs
/**
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/tailwind-merge.js
...
function twMerge(...classLists) {
	...
	if (cacheValue) return cacheValue(...classLists);
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/resolve-theme.js
...
function resolveTheme([base, ...custom], clearThemeList, applyThemeList) {
	...
	if (_clearThemeList?.length) {
		...
		for (const clearTheme of _clearThemeList) {
			if (clearTheme) run = true;
			patchClearTheme(finalClearTheme, clearTheme);
		}
		if (run) runClearTheme(baseTheme, finalClearTheme);
	}
	if (dark === false || version === 4 || prefix) stringIterator(baseTheme, (value) => {
		if (dark === false) value = stripDark(value);
		if (version === 4) value = convertUtilitiesToV4(value);
		if (prefix) {
			if (version === 3) value = applyPrefixV3(value, prefix);
			if (version === 4) value = applyPrefix(value, prefix);
		}
		return value;
	});
	let theme = baseTheme;
	if (_custom?.length) theme = deepMergeStrings(twMerge)(baseTheme, ..._custom);
	if (_applyThemeList?.length && _custom?.length) {
		...
		for (const applyTheme of _applyThemeList) {
			if (applyTheme !== "merge") run = true;
			patchApplyTheme(finalApplyTheme, applyTheme);
		}
		if (run) runApplyTheme(theme, deepmerge(baseTheme, ...custom), finalApplyTheme);
	}
	return theme;
}
function patchClearTheme(base, clearTheme) {
	function iterate(base2, clearTheme2) {
		if (typeof clearTheme2 === "boolean") if (typeof base2 === "object" && base2 !== null) for (const key in base2) base2[key] = iterate(base2[key], clearTheme2);
		else return clearTheme2;
		if (typeof clearTheme2 === "object" && clearTheme2 !== null) for (const key in clearTheme2) base2[key] = iterate(base2[key], clearTheme2[key]);
		return base2;
	}
...
function patchApplyTheme(base, applyTheme) {
	function iterate(base2, applyTheme2) {
		if (typeof applyTheme2 === "string") if (typeof base2 === "object" && base2 !== null) for (const key in base2) base2[key] = iterate(base2[key], applyTheme2);
		else return applyTheme2;
		if (typeof applyTheme2 === "object" && applyTheme2 !== null) for (const key in applyTheme2) base2[key] = iterate(base2[key], applyTheme2[key]);
		return base2;
	}
...
function runClearTheme(base, clearTheme) {
	function iterate(base2, clearTheme2) {
		if (clearTheme2 === true) if (typeof base2 === "object" && base2 !== null) for (const key in base2) base2[key] = iterate(base2[key], clearTheme2);
		else return "";
		if (typeof clearTheme2 === "object" && clearTheme2 !== null) for (const key in clearTheme2) base2[key] = iterate(base2[key], clearTheme2[key]);
		return base2;
	}
...
function runApplyTheme(base, target, applyTheme) {
	function iterate(base2, target2, applyTheme2) {
		if (applyTheme2 === "replace") if (typeof base2 === "object" && base2 !== null) for (const key in base2) base2[key] = iterate(base2[key], target2[key], applyTheme2);
		else return target2;
		if (typeof applyTheme2 === "object" && applyTheme2 !== null) for (const key in applyTheme2) base2[key] = iterate(base2[key], target2[key], applyTheme2[key]);
		return base2;
	}
...
function stringIterator(input, callback) {
	function iterate(input2) {
		if (typeof input2 === "string") return callback(input2);
		else if (Array.isArray(input2)) for (let i = 0; i < input2.length; i++) input2[i] = iterate(input2[i]);
		else if (typeof input2 === "object" && input2 !== null) for (const key in input2) input2[key] = iterate(input2[key]);
		return input2;
	}
	iterate(input);
}
function cloneWithValue(input, value) {
	if (input === null || typeof input !== "object") return value;
	const clone = {};
	for (const key in input) clone[key] = cloneWithValue(input[key], value);
	return clone;
}
//#endregion
//#region node_modules/flowbite-react/dist/icons/chevron-down-icon.js
var ChevronDownIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
...
//#endregion
//#region node_modules/flowbite-react/dist/theme/provider.js
...
function ThemeProvider({ children, root, props, theme, clearTheme, applyTheme }) {
	const parentProvider = (0, import_react.useContext)(ThemeProviderContext);
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/create-theme.js
function createTheme(input) {
	return input;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Accordion/theme.js
var accordionTheme = createTheme({
	...
	content: { base: "p-5 first:rounded-t-lg last:rounded-b-lg dark:bg-gray-900" },
	title: {
		arrow: {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Accordion/Accordion.js
function Accordion(props) {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		accordionTheme.root,
		provider.theme?.accordion?.root,
		props.theme
	], [get(provider.clearTheme, "accordion.root"), props.clearTheme], [get(provider.applyTheme, "accordion.root"), props.applyTheme]);
	const { alwaysOpen = false, arrowIcon = ChevronDownIcon, children, flush = false, collapseAll = false, className, ...restProps } = resolveProps(props, provider.props?.accordion);
	const [isOpen, setOpen] = (0, import_react.useState)(collapseAll ? -1 : 0);
	const panels = (0, import_react.useMemo)(() => import_react.Children.map(children, (child, i) => (0, import_react.cloneElement)(child, {
		alwaysOpen,
		arrowIcon,
		flush,
		isOpen: isOpen === i,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Accordion/AccordionPanelContext.js
...
function useAccordionContext() {
	...
	if (!context) throw new Error("useAccordionContext should be used within the AccordionPanelContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Accordion/AccordionContent.js
function AccordionContent(props) {
	const { isOpen } = useAccordionContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		accordionTheme.content,
		provider.theme?.accordion?.content,
		props.theme
	], [get(provider.clearTheme, "accordion.content"), props.clearTheme], [get(provider.applyTheme, "accordion.content"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Accordion/AccordionPanel.js
function AccordionPanel({ children, ...props }) {
	const { alwaysOpen } = props;
	const [isOpen, setOpen] = (0, import_react.useState)(props.isOpen);
	const provider = alwaysOpen ? {
		...props,
		isOpen,
		setOpen: () => setOpen(!isOpen)
	} : props;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionPanelContext.Provider, {
		value: provider,
		children
	});
}
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Accordion/AccordionTitle.js
function AccordionTitle(props) {
	...
	const theme = useResolveTheme([
		...
		provider.theme?.accordion?.title,
		props.theme
	], [get(provider.clearTheme, "accordion.title"), props.clearTheme], [get(provider.applyTheme, "accordion.title"), props.applyTheme]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading, {
			...
			children
		}), ArrowIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowIcon, {
			"aria-hidden": true,
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/x-icon.js
var XIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Alert/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Alert/Alert.js
var Alert = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		...
		props.theme
	], [get(provider.clearTheme, "alert"), props.clearTheme], [get(provider.applyTheme, "alert"), props.applyTheme]);
	const { additionalContent, children, className, color = "info", icon: Icon, onDismiss, rounded = true, withBorderAccent, ...restProps } = resolveProps(props, provider.props?.alert);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				typeof onDismiss === "function" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					"aria-label": "Dismiss",
		...
		}), additionalContent && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: additionalContent })]
	});
});
Alert.displayName = "Alert";
//#endregion
//#region node_modules/flowbite-react/dist/components/Avatar/theme.js
var avatarTheme = createTheme({
	...
	groupCounter: { base: "relative flex h-10 w-10 items-center justify-center rounded-full bg-gray-700 text-xs font-medium text-white ring-2 ring-gray-300 hover:bg-gray-600 dark:ring-gray-500" }
});
//#endregion
//#region node_modules/flowbite-react/dist/components/Avatar/Avatar.js
var Avatar = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		avatarTheme,
		provider.theme?.avatar,
		props.theme
	], [get(provider.clearTheme, "avatar"), props.clearTheme], [get(provider.applyTheme, "avatar"), props.applyTheme]);
	const { alt = "", bordered = false, children, className, color = "light", img, placeholderInitials = "", rounded = false, size = "md", stacked = false, status, statusPosition = "top-left", ...restProps } = resolveProps(props, provider.props?.avatar);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [img ? typeof img === "string" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				alt,
				src: img,
				...imgProps
			}) : img({
				alt,
				...imgProps
			}) : placeholderInitials ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Avatar/AvatarGroup.js
var AvatarGroup = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		avatarTheme.group,
		provider.theme?.avatar?.group,
		props.theme
	], [get(provider.clearTheme, "avatar"), props.clearTheme], [get(provider.applyTheme, "avatar"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Avatar/AvatarGroupCounter.js
var AvatarGroupCounter = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		avatarTheme.groupCounter,
		provider.theme?.avatar?.groupCounter,
		props.theme
	], [get(provider.clearTheme, "avatar.groupCounter"), props.clearTheme], [get(provider.applyTheme, "avatar.groupCounter"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Badge/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Badge/Badge.js
var Badge = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		badgeTheme,
		provider.theme?.badge,
		props.theme
	], [get(provider.clearTheme, "badge"), props.clearTheme], [get(provider.applyTheme, "badge"), props.applyTheme]);
	const { children, color = "info", icon: Icon, size = "xs", className, ...restProps } = resolveProps(props, provider.props?.badge);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Banner/Banner.js
var Banner = (0, import_react.forwardRef)((props, ref) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
		"data-testid": "flowbite-banner",
		role: "banner",
		tabIndex: -1,
		...resolveProps(props, useThemeProvider().props?.banner)
	});
});
Banner.displayName = "Banner";
//#endregion
//#region node_modules/flowbite-react/dist/components/Button/ButtonBase.js
var ButtonBase = (0, import_react.forwardRef)(({ children, as: Component, href, type = "button", ...props }, ref) => {
	return (0, import_react.createElement)(Component || (href ? "a" : "button"), {
		ref,
		href,
		type,
		...props
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Button/ButtonGroupContext.js
var ButtonGroupContext = (0, import_react.createContext)(void 0);
function useButtonGroupContext() {
	return (0, import_react.useContext)(ButtonGroupContext);
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Button/theme.js
...
var buttonGroupTheme = createTheme({ base: "inline-flex rounded-md shadow-sm" });
//#endregion
//#region node_modules/flowbite-react/dist/components/Button/Button.js
var Button = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		...
		props.theme
	], [get(provider.clearTheme, "button"), props.clearTheme], [get(provider.applyTheme, "button"), props.applyTheme]);
	const { children, className, color = "default", disabled, fullSized, outline: _outline, pill: _pill, size = "md", ...restProps } = resolveProps(props, provider.props?.button);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Banner/BannerCollapseButton.js
var BannerCollapseButton = (0, import_react.forwardRef)((props, ref) => {
	const mergedProps = resolveProps(props, useThemeProvider().props?.bannerCollapseButton);
	function onClick(e) {
		e.target.closest("[role=\"banner\"]")?.remove();
	}
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Banner/theme.js
var bannerTheme = createTheme({});
//#endregion
//#region node_modules/flowbite-react/dist/components/Blockquote/theme.js
var blockquoteTheme = createTheme({ root: { base: "text-xl font-semibold italic text-gray-900 dark:text-white" } });
//#endregion
//#region node_modules/flowbite-react/dist/components/Blockquote/Blockquote.js
var Blockquote = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		blockquoteTheme,
		provider.theme?.blockquote,
		props.theme
	], [get(provider.clearTheme, "blockquote"), props.clearTheme], [get(provider.applyTheme, "blockquote"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Breadcrumb/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Breadcrumb/Breadcrumb.js
var Breadcrumb = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		breadcrumbTheme.root,
		provider.theme?.breadcrumb?.root,
		props.theme
	], [get(provider.clearTheme, "breadcrumb.root"), props.clearTheme], [get(provider.applyTheme, "breadcrumb.root"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/chevron-right-icon.js
var ChevronRightIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "none",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Breadcrumb/BreadcrumbItem.js
var BreadcrumbItem = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		breadcrumbTheme.item,
		provider.theme?.breadcrumb?.item,
		props.theme
	], [get(provider.clearTheme, "breadcrumb.item"), props.clearTheme], [get(provider.applyTheme, "breadcrumb.item"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Button/ButtonGroup.js
var ButtonGroup = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		buttonGroupTheme,
		provider.theme?.buttonGroup,
		props.theme
	], [get(provider.clearTheme, "buttonGroup"), props.clearTheme], [get(provider.applyTheme, "buttonGroup"), props.applyTheme]);
	const { children, className, outline, pill, ...restProps } = resolveProps(props, provider.props?.buttonGroup);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ButtonGroupContext.Provider, {
		value: {
			outline,
			pill
		},
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Card/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Card/Card.js
var Card = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		cardTheme,
		provider.theme?.card,
		props.theme
	], [get(provider.clearTheme, "card"), props.clearTheme], [get(provider.applyTheme, "card"), props.applyTheme]);
	const { children, className, horizontal, href, imgAlt, imgSrc, renderImage, ...restProps } = resolveProps(props, provider.props?.card);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(typeof href === "undefined" ? "div" : "a", {
		ref,
		"data-testid": "flowbite-card",
		href,
		className: twMerge(theme.root.base, theme.root.horizontal[horizontal ? "on" : "off"], href && theme.root.href, className),
		...restProps,
		children: [renderImage?.(theme, !!horizontal) ?? (imgSrc && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/drag-scroll.js
...
var LEFT_BUTTON = 0;
var ScrollContainer = class extends import_react.PureComponent {
	constructor(props) {
		super(props);
		...
		__publicField(this, "onEndScroll", () => {
			...
			if (!this.pressed && this.started) this.processEnd();
		});
		...
		__publicField(this, "onTouchStart", (e) => {
			...
			if (this.isDraggable(e.target)) {
				this.internal = true;
				if (nativeMobileScroll && this.scrolling) this.pressed = true;
				else {
					const touch = e.touches[0];
					this.processClick(touch.clientX, touch.clientY);
					if (!nativeMobileScroll && this.props.stopPropagation) e.stopPropagation();
				}
			}
		});
		__publicField(this, "onTouchEnd", () => {
			const { nativeMobileScroll } = this.props;
			if (this.pressed) {
				if (this.started && (!this.scrolling || !nativeMobileScroll)) this.processEnd();
		...
		__publicField(this, "onTouchMove", (e) => {
			...
			if (this.pressed && (!nativeMobileScroll || !this.isMobile)) {
				const touch = e.touches[0];
				if (touch) this.processMove(touch.clientX, touch.clientY);
				e.preventDefault();
		...
		__publicField(this, "onMouseUp", (e) => {
			if (this.pressed) {
				if (this.started) this.processEnd();
				else {
					this.internal = false;
					this.pressed = false;
					this.forceUpdate();
		...
		this.container = import_react.createRef();
	...
	componentDidMount() {
		...
		if (nativeMobileScroll) {
			...
			if (this.isMobile) this.forceUpdate();
		}
	}
	...
	processStart(changeCursor = true) {
		...
		this.started = true;
		if (changeCursor) document.body.classList.add("cursor-grab");
		if (onStartScroll) onStartScroll({ external: !this.internal });
		this.forceUpdate();
	}
	processScroll() {
		if (this.started) {
			const { onScroll } = this.props;
			if (onScroll) onScroll({ external: !this.internal });
	...
	processMove(newClientX, newClientY) {
		...
		if (!this.started) {
			...
			if (horizontal) container.scrollLeft -= newClientX - this.clientX;
			if (vertical) container.scrollTop -= newClientY - this.clientY;
			if (onScroll) onScroll({ external: !this.internal });
			this.clientX = newClientX;
			this.clientY = newClientY;
			this.scrollLeft = container.scrollLeft;
	...
	processEnd() {
		...
		if (this.container.current && onEndScroll) onEndScroll({ external: !this.internal });
		this.pressed = false;
		this.started = false;
		this.scrolling = false;
		this.internal = false;
	...
	render() {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: twMerge(className, this.pressed && draggingClassName, this.pressed && "!scroll-auto [&>*]:pointer-events-none [&>*]:cursor-grab", this.isMobile && "overflow-auto", hideScrollbars && "overflow-hidden !overflow-x-hidden [scrollbar-width:none]", hideScrollbars && "[&::-webkit-scrollbar]:!hidden [&::-webkit-scrollbar]:!h-0 [&::-webkit-scrollbar]:!w-0 [&::-webkit-scrollbar]:!bg-transparent [&::-webkit-scrollbar]:![-webkit-appearance:none]"),
			style,
			ref: this.getRef,
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/is-client.js
function isClient() {
	return typeof window !== "undefined";
}
//#endregion
//#region node_modules/flowbite-react/dist/icons/chevron-left-icon.js
var ChevronLeftIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "none",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Carousel/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Carousel/Carousel.js
var Carousel = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		carouselTheme,
		provider.theme?.carousel,
		props.theme
	], [get(provider.clearTheme, "carousel"), props.clearTheme], [get(provider.applyTheme, "carousel"), props.applyTheme]);
	const { children, indicators = true, leftControl, rightControl, slide = true, draggable = true, slideInterval, className, onSlideChange, pauseOnHover = false, ...restProps } = resolveProps(props, provider.props?.carousel);
	const isDeviceMobile = isClient() && navigator.userAgent.indexOf("IEMobile") !== -1;
	const carouselContainer = (0, import_react.useRef)(null);
	const [activeItem, setActiveItem] = (0, import_react.useState)(0);
	const [isDragging, setIsDragging] = (0, import_react.useState)(false);
	const [isHovering, setIsHovering] = (0, import_react.useState)(false);
	const didMountRef = (0, import_react.useRef)(false);
	const items = (0, import_react.useMemo)(() => import_react.Children.map(children, (child) => (0, import_react.cloneElement)(child, { className: twMerge(theme.item.base, child.props.className) })), [children, theme.item.base]);
	const navigateTo = (0, import_react.useCallback)((item) => () => {
		if (!items) return;
		item = (item + items.length) % items.length;
		if (carouselContainer.current) carouselContainer.current.scrollLeft = carouselContainer.current.clientWidth * item;
		setActiveItem(item);
	}, [items]);
	(0, import_react.useEffect)(() => {
		if (carouselContainer.current && !isDragging && carouselContainer.current.scrollLeft !== 0) setActiveItem(Math.round(carouselContainer.current.scrollLeft / carouselContainer.current.clientWidth));
	}, [isDragging]);
	(0, import_react.useEffect)(() => {
	...
	(0, import_react.useEffect)(() => {
		if (didMountRef.current) onSlideChange?.(activeItem);
		else didMountRef.current = true;
	}, [onSlideChange, activeItem]);
	const handleDragging = (dragging) => () => setIsDragging(dragging);
	const setHoveringTrue = (0, import_react.useCallback)(() => setIsHovering(true), []);
	const setHoveringFalse = (0, import_react.useCallback)(() => setIsHovering(false), []);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref,
		className: twMerge(theme.root.base, className),
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollContainer, {
				...
				children: items?.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			indicators && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: items?.map((_, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			items && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: leftControl ? leftControl : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DefaultLeftControl, { theme: theme.control })
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					children: rightControl ? rightControl : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DefaultRightControl, { theme: theme.control })
				})
			})] })
		]
	});
...
function DefaultLeftControl({ theme }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeftIcon, { className: theme.icon })
	});
}
function DefaultRightControl({ theme }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: theme.base,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRightIcon, { className: theme.icon })
	});
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Checkbox/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Checkbox/Checkbox.js
var Checkbox = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		checkboxTheme,
		provider.theme?.checkbox,
		props.theme
	], [get(provider.clearTheme, "checkbox"), props.clearTheme], [get(provider.applyTheme, "checkbox"), props.applyTheme]);
...
function FloatingList(props) {
	...
	const [nodes, setNodes] = import_react.useState(() => /* @__PURE__ */ new Set());
	...
	const map = import_react.useMemo(() => {
...
function useListItem(props) {
	...
	const [index, setIndex] = import_react.useState(null);
...
*/
var useId$12 = SafeReact.useId || useFloatingId;
...
function FloatingFocusManager(props) {
	...
	const blurTimeoutRef = import_react.useRef(-1);
...
function enableScrollLock() {
	...
	const isIOS = /iP(hone|ad|od)|iOS/.test(platform) || platform === "MacIntel" && navigator.maxTouchPoints > 1;
...
*/
var FloatingOverlay = /* @__PURE__ */ import_react.forwardRef(function FloatingOverlay(props, ref) {
...
function useListNavigation(context, props) {
	...
	const previousMountedRef = import_react.useRef(!!elements.floating);
...
function useRole(context, props) {
	...
	const defaultReferenceId = useId$12();
...
function useTypeahead(context, props) {
	...
	const timeoutIdRef = import_react.useRef(-1);
	...
	const reference = import_react.useMemo(() => ({ onKeyDown }), [onKeyDown]);
	const floating = import_react.useMemo(() => {
		return {
			onKeyDown,
			onKeyUp(event) {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Floating/helpers.js
...
//#endregion
//#region node_modules/flowbite-react/dist/hooks/use-floating.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Floating/Floating.js
function Floating({ animation = "duration-300", arrow = true, children, className, content, placement = "top", style = "dark", theme, trigger = "hover", minWidth, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: content
		}), arrow && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Tooltip/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Tooltip/Tooltip.js
function Tooltip(props) {
	...
	const theme = useResolveTheme([
		...
		props.theme
	], [get(provider.clearTheme, "tooltip"), props.clearTheme], [get(provider.applyTheme, "tooltip"), props.applyTheme]);
	const { animation = "duration-300", arrow = true, children, className, content, placement = "top", style = "dark", trigger = "hover", ...restProps } = resolveProps(props, provider.props?.tooltip);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Floating, {
		animation,
		arrow,
		content,
		placement,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Clipboard/helpers.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Clipboard/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Clipboard/Clipboard.js
var Clipboard = (0, import_react.forwardRef)((props, ref) => {
	const [isJustCopied, setIsJustCopied] = (0, import_react.useState)(false);
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		clipboardTheme.button,
		provider.theme?.clipboard?.button,
		props.theme
	], [get(provider.clearTheme, "clipboard.button"), props.clearTheme], [get(provider.applyTheme, "clipboard.button"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/check-icon.js
var CheckIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/clipboard-list-icon.js
var ClipboardListIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Clipboard/ClipboardWithIcon.js
var ClipboardWithIcon = (0, import_react.forwardRef)((props, ref) => {
	const [isJustCopied, setIsJustCopied] = (0, import_react.useState)(false);
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		clipboardTheme.withIcon,
		provider.theme?.clipboard?.withIcon,
		props.theme
	], [get(provider.clearTheme, "clipboard.withIcon"), props.clearTheme], [get(provider.applyTheme, "clipboard.withIcon"), props.applyTheme]);
	const { valueToCopy, icon: Icon = ClipboardListIcon, className, ...restProps } = resolveProps(props, provider.props?.clipboardWithIcon);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		className: twMerge(theme.base, className),
		onClick: () => copyToClipboard(valueToCopy, setIsJustCopied),
		...restProps,
		ref,
		children: isJustCopied ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckIcon, {
			"aria-hidden": true,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Clipboard/ClipboardWithIconText.js
var ClipboardWithIconText = (0, import_react.forwardRef)((props, ref) => {
	const [isJustCopied, setIsJustCopied] = (0, import_react.useState)(false);
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		clipboardTheme.withIconText,
		provider.theme?.clipboard?.withIconText,
		props.theme
	], [get(provider.clearTheme, "clipboard.withIconText"), props.clearTheme], [get(provider.applyTheme, "clipboard.withIconText"), props.applyTheme]);
	const { valueToCopy, icon: Icon = ClipboardListIcon, label = "Copy", className, ...rest } = resolveProps(props, provider.props?.clipboardWithIconText);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		className: twMerge(theme.base, className),
		onClick: () => copyToClipboard(valueToCopy, setIsJustCopied),
		...rest,
		ref,
		children: isJustCopied ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
...
//#endregion
//#region node_modules/flowbite-react/dist/hooks/use-watch-localstorage-value.js
...
//#endregion
//#region node_modules/flowbite-react/dist/hooks/use-theme-mode.js
var DEFAULT_MODE = "auto";
var LS_THEME_MODE = "flowbite-theme-mode";
var SYNC_THEME_MODE = "flowbite-theme-mode-sync";
function useThemeMode() {
	const [mode, setMode] = (0, import_react.useState)(getInitialMode(getMode()));
	...
	function clearMode() {
		handleSetMode(mode ?? DEFAULT_MODE);
	}
	return {
		mode,
...
function setModeInDOM(mode) {
	...
	const prefix = getPrefix() ?? "";
	const className = getVersion() === 3 ? `${prefix}dark` : "dark";
	if (computedMode === "dark") document.documentElement.classList.add(className);
...
function getInitialMode(defaultMode) {
	...
	return validateMode(localStorage.getItem(LS_THEME_MODE) ?? defaultMode ?? DEFAULT_MODE);
}
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/moon-icon.js
var MoonIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/sun-icon.js
var SunIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/DarkThemeToggle/theme.js
var darkThemeToggleTheme = createTheme({ root: {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/DarkThemeToggle/DarkThemeToggle.js
var DarkThemeToggle = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		darkThemeToggleTheme,
		provider.theme?.darkThemeToggle,
		props.theme
	], [get(provider.clearTheme, "darkThemeToggle"), props.clearTheme], [get(provider.applyTheme, "darkThemeToggle"), props.applyTheme]);
	const { className, iconDark: IconDark = SunIcon, iconLight: IconLight = MoonIcon, ...restProps } = resolveProps(props, provider.props?.darkThemeToggle);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		onClick: toggleMode,
		...restProps,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconDark, {
			"aria-label": "Currently dark mode",
			className: twMerge(theme.root.icon.base, theme.root.icon.dark)
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IconLight, {
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/arrow-left-icon.js
var ArrowLeftIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/arrow-right-icon.js
var ArrowRightIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/calendar-icon.js
var CalendarIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/TextInput/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/TextInput/TextInput.js
var TextInput = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		textInputTheme,
		provider.theme?.textInput,
		props.theme
	], [get(provider.clearTheme, "textInput"), props.clearTheme], [get(provider.applyTheme, "textInput"), props.applyTheme]);
	const { addon, className, color = "gray", icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", type = "text", ...restProps } = resolveProps(props, provider.props?.textInput);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: twMerge(theme.base, className),
		children: [addon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			children: [
				Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: theme.field.icon.svg })
				}),
				RightIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"data-testid": "right-icon",
					className: theme.field.rightIcon.base,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RightIcon, { className: theme.field.rightIcon.svg })
				}),
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Datepicker/DatepickerContext.js
var DatepickerContext = (0, import_react.createContext)(void 0);
function useDatePickerContext() {
	const context = (0, import_react.useContext)(DatepickerContext);
	if (!context) throw new Error("useDatePickerContext should be used within the DatePickerContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Datepicker/helpers.js
...
function isDateInRange(date, minDate, maxDate) {
	...
	if (minDate) return dateTime >= new Date(minDate.getFullYear(), minDate.getMonth(), minDate.getDate()).getTime();
	if (maxDate) return dateTime <= new Date(maxDate.getFullYear(), maxDate.getMonth(), maxDate.getDate()).getTime();
	return true;
}
...
function getWeekDays(lang, weekStart) {
	...
	for (let i = 0; i < 7; i++) weekdays.push(formatter.format(addDays(date, i)));
	return weekdays;
}
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Datepicker/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Datepicker/Views/Days.js
function DatepickerViewsDays() {
	const { theme: rootTheme, weekStart, minDate, maxDate, filterDate, viewDate, selectedDate, changeSelectedDate, language } = useDatePickerContext();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: weekDays.map((day, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		children: [...Array(42)].map((_date, index) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				disabled: isDisabled,
				type: "button",
				className: twMerge(theme.items.item.base, isToday && theme.items.item.today, isSelected && theme.items.item.selected, isDisabled && theme.items.item.disabled),
				onClick: () => {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Datepicker/Views/Decades.js
function DatepickerViewsDecades() {
	const { theme: rootTheme, viewDate, selectedDate, minDate, maxDate, filterDate, setViewDate, setView } = useDatePickerContext();
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Datepicker/Views/Months.js
function DatepickerViewsMonth() {
	const { theme: rootTheme, minDate, maxDate, filterDate, selectedDate, viewDate, language, setViewDate, setView } = useDatePickerContext();
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Datepicker/Views/Years.js
function DatepickerViewsYears() {
	const { theme: rootTheme, selectedDate, minDate, maxDate, filterDate, viewDate, setViewDate, setView } = useDatePickerContext();
	const theme = rootTheme.views.years;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: theme.items.base,
		children: [...Array(12)].map((_year, index) => {
			const year = startOfYearPeriod(viewDate, 10) + index;
			const newDate = new Date(viewDate.getTime());
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Datepicker/Datepicker.js
var Datepicker = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		datePickerTheme,
		provider.theme?.datepicker,
		props.theme
	], [get(provider.clearTheme, "datepicker"), props.clearTheme], [get(provider.applyTheme, "datepicker"), props.applyTheme]);
	const { title, open, inline = false, autoHide = true, showClearButton = true, labelClearButton = "Clear", showTodayButton = true, labelTodayButton = "Today", defaultValue, minDate, maxDate, filterDate, language = "en", weekStart = WeekStart.Sunday, className, onChange, label, value, ...restProps } = resolveProps(props, provider.props?.datepicker);
	const initialDate = defaultValue ? getFirstDateInRange(defaultValue, minDate, maxDate) : null;
	const effectiveDefaultView = (0, import_react.useMemo)(() => {
	...
	const [view, setView] = (0, import_react.useState)(Views.Days);
	const [selectedDate, setSelectedDate] = (0, import_react.useState)(value ?? initialDate);
	const [viewDate, setViewDate] = (0, import_react.useState)(value ?? effectiveDefaultView);
	const inputRef = (0, import_react.useRef)(null);
	const datepickerRef = (0, import_react.useRef)(null);
	function changeSelectedDate(date, useAutohide) {
		setSelectedDate(date);
		if ((date === null || date) && onChange) onChange(date);
		if (autoHide && view === Views.Days && useAutohide == true && !inline) setIsOpen(false);
	}
	function clearDate() {
		changeSelectedDate(initialDate, true);
		if (defaultValue) setViewDate(defaultValue);
	}
	...
	function renderView(type) {
		switch (type) {
			case Views.Decades: return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DatepickerViewsDecades, {});
			case Views.Years: return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DatepickerViewsYears, {});
			case Views.Months: return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DatepickerViewsMonth, {});
			case Views.Days:
			default: return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DatepickerViewsDays, {});
		}
	}
	function getNextView() {
		switch (view) {
			case Views.Days: return Views.Months;
			case Views.Months: return Views.Years;
			case Views.Years: return Views.Decades;
		}
		return view;
	}
	function getViewTitle() {
		switch (view) {
			case Views.Decades: return `${startOfYearPeriod(viewDate, 100) - 10} - ${startOfYearPeriod(viewDate, 100) + 100}`;
			case Views.Years: return `${startOfYearPeriod(viewDate, 10)} - ${startOfYearPeriod(viewDate, 10) + 11}`;
			case Views.Months: return getFormattedDate(language, viewDate, { year: "numeric" });
			case Views.Days:
			default: return getFormattedDate(language, viewDate, {
				month: "long",
				year: "numeric"
			});
		}
	...
	function getViewDatePage(view2, date, value2) {
		switch (view2) {
			case Views.Days: return new Date(addMonths(date, value2));
			case Views.Months: return new Date(addYears(date, value2));
			case Views.Years: return new Date(addYears(date, value2 * 10));
			case Views.Decades: return new Date(addYears(date, value2 * 100));
			default: return new Date(addYears(date, value2 * 10));
		}
	}
	(0, import_react.useEffect)(() => {
		const handleClickOutside = (event) => {
			...
			if (!clickedInsideDatepicker && !clickedInsideInput) setIsOpen(false);
		};
	...
	(0, import_react.useEffect)(() => {
		...
		if (effectiveSelectedDate && effectiveValue && !isDateEqual(effectiveValue, effectiveSelectedDate)) setSelectedDate(effectiveValue);
		if (selectedDate == null) setSelectedDate(initialDate);
	}, [
		value,
		setSelectedDate,
		setViewDate,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DatepickerContext.Provider, {
		value: {
			theme,
			language,
			minDate,
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: twMerge(theme.root.base, className),
			children: [!inline && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextInput, {
				theme: theme.root.input,
				icon: CalendarIcon,
				ref: inputRef,
				onFocus: () => {
					if (selectedDate && !isDateEqual(viewDate, selectedDate)) setViewDate(selectedDate);
					setIsOpen(true);
				},
				value: displayValue,
				...
				readOnly: true,
				...restProps
			}), (isOpen || inline) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: datepickerRef,
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(showClearButton || showTodayButton) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: theme.popup.footer.base,
							children: [showTodayButton && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
							...
							}), showClearButton && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Drawer/DrawerContext.js
var DrawerContext = (0, import_react.createContext)(void 0);
function useDrawerContext() {
	const context = (0, import_react.useContext)(DrawerContext);
	if (!context) throw new Error("useDrawerContext should be used within the DrawerContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Drawer/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Drawer/Drawer.js
var Drawer = (0, import_react.forwardRef)((props, ref) => {
	const id = (0, import_react.useId)();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		drawerTheme,
		provider.theme?.drawer,
		props.theme
	], [get(provider.clearTheme, "drawer"), props.clearTheme], [get(provider.applyTheme, "drawer"), props.applyTheme]);
	const { backdrop = true, children, className, edge = false, position = "left", onClose, open: isOpen = false, ...restProps } = resolveProps(props, provider.props?.drawer);
	(0, import_react.useEffect)(() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DrawerContext.Provider, {
		value: {
			theme: props.theme,
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			...restProps,
			children
		}), isOpen && backdrop && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			onClick: () => onClose(),
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/close-icon.js
var CloseIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/home-icon.js
var HomeIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Drawer/DrawerHeader.js
var DrawerHeader = (0, import_react.forwardRef)((props, ref) => {
	const id = (0, import_react.useId)();
	const { id: mainDivId, isOpen, onClose, theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useDrawerContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		drawerTheme.header,
		provider.theme?.drawer?.header,
		rootTheme?.header,
		props.theme
	], [
		get(provider.clearTheme, "drawer.header"),
		get(rootClearTheme, "header"),
		props.clearTheme
	], [
		get(provider.applyTheme, "drawer.header"),
		get(rootApplyTheme, "header"),
		props.applyTheme
	]);
	const { children, className, closeIcon: CloseIcon$1 = CloseIcon, title, titleIcon: TitleIcon = HomeIcon, ...restProps } = resolveProps(props, provider.props?.drawerHeader);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref,
		className,
		...restProps,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h5", {
				...
				id: mainDivId,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TitleIcon, {
					"aria-hidden": true,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Drawer/DrawerItems.js
var DrawerItems = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useDrawerContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		drawerTheme.items,
		provider.theme?.drawer?.items,
		rootTheme?.items,
		props.theme
	], [
		get(provider.clearTheme, "drawer.items"),
		get(rootClearTheme, "items"),
		props.clearTheme
	], [
		get(provider.applyTheme, "drawer.items"),
		get(rootApplyTheme, "items"),
		props.applyTheme
	]);
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/chevron-up-icon.js
var ChevronUpIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "none",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Dropdown/DropdownContext.js
var DropdownContext = (0, import_react.createContext)(void 0);
function useDropdownContext() {
	const context = (0, import_react.useContext)(DropdownContext);
	if (!context) throw new Error("useDropdownContext should be used within the DropdownContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Dropdown/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Dropdown/Dropdown.js
var icons = {
	top: ChevronUpIcon,
...
function Trigger({ refs, children, inline, theme, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) {
	...
	if (renderTrigger) {
		...
		return (0, import_react.cloneElement)(triggerElement, {
			ref: refs.setReference,
			disabled,
			...a11yProps,
	...
	return inline ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		type: "button",
		ref: refs.setReference,
...
function Dropdown(props) {
	...
	const [buttonWidth, setButtonWidth] = (0, import_react.useState)(void 0);
	...
	const theme = useResolveTheme([
		...
		props.theme
	], [get(provider.clearTheme, "dropdown"), props.clearTheme], [get(provider.applyTheme, "dropdown"), props.applyTheme]);
	const { children, className, dismissOnClick = true, enableTypeAhead = true, renderTrigger, ...restProps } = resolveProps(props, provider.props?.dropdown);
	...
	const handleTypeaheadMatch = (0, import_react.useCallback)((index) => {
	...
	const { getReferenceProps, getFloatingProps, getItemProps } = useFloatingInteractions({
		...
		role: "menu",
		trigger,
		interactions: [useListNavigation(context, {
			listRef: elementsRef,
			activeIndex,
			selectedIndex,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownContext.Provider, {
		value: {
			theme: props.theme,
			clearTheme: props.clearTheme,
			applyTheme: props.applyTheme,
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Trigger, {
			...
			getReferenceProps,
			renderTrigger,
			children: [label, arrowIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: theme.arrowIcon })]
		}), open && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingFocusManager, {
			context,
			modal: false,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: refs.setFloating,
				...
				"aria-expanded": open,
				...getFloatingProps({ className: twMerge(theme.floating.base, theme.floating.animation, "duration-100", !open && theme.floating.hidden, theme.floating.style.auto, className) }),
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Dropdown/DropdownDivider.js
var DropdownDivider = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		...
		get(provider.clearTheme, "dropdown.floating"),
		get(rootClearTheme, "floating"),
		props.clearTheme
	], [
		get(provider.applyTheme, "dropdown.floating"),
		get(rootApplyTheme, "floating"),
		props.applyTheme
	]);
	const { className, ...restProps } = resolveProps(props, provider.props?.dropdownDivider);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
		className: twMerge(theme.divider, className),
		...restProps
	});
});
DropdownDivider.displayName = "DropdownDivider";
//#endregion
//#region node_modules/flowbite-react/dist/components/Dropdown/DropdownHeader.js
var DropdownHeader = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useDropdownContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		dropdownTheme.floating,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Dropdown/DropdownItem.js
var DropdownItem = (0, import_react.forwardRef)((props, forwardedRef) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, activeIndex, dismissOnClick, getItemProps, handleSelect } = useDropdownContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		...
		get(provider.clearTheme, "dropdown.floating.item"),
		get(rootClearTheme, "floating.item"),
		props.clearTheme
	], [
		get(provider.applyTheme, "dropdown.floating.item"),
		get(rootApplyTheme, "floating.item"),
		props.applyTheme
	]);
	const { children, className, icon: Icon, onClick, ...restProps } = resolveProps(props, provider.props?.dropdownItem);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ButtonBase, {
			ref,
			className: twMerge(theme.base, className),
			...restProps,
			...
			children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: theme.icon }), children]
		})
	});
});
DropdownItem.displayName = "DropdownItem";
//#endregion
//#region node_modules/flowbite-react/dist/components/FileInput/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/FileInput/FileInput.js
var FileInput = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		fileInputTheme,
		provider.theme?.fileInput,
		props.theme
	], [get(provider.clearTheme, "fileInput"), props.clearTheme], [get(provider.applyTheme, "fileInput"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/FloatingLabel/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/FloatingLabel/FloatingLabel.js
var FloatingLabel = (0, import_react.forwardRef)((props, ref) => {
	const randomId = (0, import_react.useId)();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		floatingLabelTheme,
		provider.theme?.floatingLabel,
		props.theme
	], [get(provider.clearTheme, "floatingLabel"), props.clearTheme], [get(provider.applyTheme, "floatingLabel"), props.applyTheme]);
	const { label, color = "default", sizing = "md", variant, disabled = false, className, ...restProps } = resolveProps(props, provider.props?.floatingLabel);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/theme.js
var footerTheme = createTheme({
	...
	divider: { base: "my-6 w-full border-gray-200 sm:mx-auto lg:my-8 dark:border-gray-700" },
	copyright: {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/Footer.js
var Footer = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		footerTheme,
		provider.theme?.footer,
		props.theme
	], [get(provider.clearTheme, "footer"), props.clearTheme], [get(provider.applyTheme, "footer"), props.applyTheme]);
	const { bgDark = false, children, className, container = false, ...restProps } = resolveProps(props, provider.props?.footer);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/FooterBrand.js
var FooterBrand = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		footerTheme.brand,
		provider.theme?.footer?.brand,
		props.theme
	], [get(provider.clearTheme, "footer.brand"), props.clearTheme], [get(provider.applyTheme, "footer.brand"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/FooterCopyright.js
var FooterCopyright = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		footerTheme.copyright,
		provider.theme?.footer?.copyright,
		props.theme
	], [get(provider.clearTheme, "footer.copyright"), props.clearTheme], [get(provider.applyTheme, "footer.copyright"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/FooterDivider.js
var FooterDivider = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		footerTheme.divider,
		provider.theme?.footer?.divider,
		props.theme
	], [get(provider.clearTheme, "footer.divider"), props.clearTheme], [get(provider.applyTheme, "footer.divider"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/FooterIcon.js
var FooterIcon = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		footerTheme.icon,
		provider.theme?.footer?.icon,
		props.theme
	], [get(provider.clearTheme, "footer.icon"), props.clearTheme], [get(provider.applyTheme, "footer.icon"), props.applyTheme]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: href ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
			...
			className: twMerge(theme.base, className),
			...restProps,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: theme.size })
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
			"data-testid": "flowbite-footer-icon",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/FooterLink.js
var FooterLink = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		footerTheme.groupLink.link,
		provider.theme?.footer?.groupLink?.link,
		props.theme
	], [get(provider.clearTheme, "footer.groupLink.link"), props.clearTheme], [get(provider.applyTheme, "footer.groupLink.link"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/FooterLinkGroup.js
var FooterLinkGroup = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		footerTheme.groupLink,
		provider.theme?.footer?.groupLink,
		props.theme
	], [get(provider.clearTheme, "footer.groupLink"), props.clearTheme], [get(provider.applyTheme, "footer.groupLink"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Footer/FooterTitle.js
var FooterTitle = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		footerTheme.title,
		provider.theme?.footer?.title,
		props.theme
	], [get(provider.clearTheme, "footer.title"), props.clearTheme], [get(provider.applyTheme, "footer.title"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/HelperText/theme.js
var helperTextTheme = createTheme({ root: {
	base: "mt-2 text-sm",
	colors: {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/HelperText/HelperText.js
var HelperText = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		helperTextTheme,
		provider.theme?.helperText,
		props.theme
	], [get(provider.clearTheme, "helperText"), props.clearTheme], [get(provider.applyTheme, "helperText"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/HR/theme.js
var hrTheme = createTheme({
	root: { base: "my-8 h-px border-0 bg-gray-200 dark:bg-gray-700" },
	trimmed: { base: "mx-auto my-4 h-1 w-48 rounded border-0 bg-gray-100 md:my-10 dark:bg-gray-700" },
	icon: {
	...
	square: { base: "mx-auto my-8 h-8 w-8 rounded border-0 bg-gray-200 md:my-12 dark:bg-gray-700" }
});
//#endregion
//#region node_modules/flowbite-react/dist/components/HR/HR.js
var HR = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		hrTheme.root,
		provider.theme?.hr?.root,
		props.theme
	], [get(provider.clearTheme, "hr.root"), props.clearTheme], [get(provider.applyTheme, "hr.root"), props.applyTheme]);
...
HR.displayName = "HR";
//#endregion
//#region node_modules/flowbite-react/dist/icons/quote-right-icon.js
var QuoteRightIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/HR/HRIcon.js
var HRIcon = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		hrTheme.icon,
		provider.theme?.hr?.icon,
		props.theme
	], [get(provider.clearTheme, "hr.icon"), props.clearTheme], [get(provider.applyTheme, "hr.icon"), props.applyTheme]);
	const { icon: Icon = QuoteRightIcon, className, ...restProps } = resolveProps(props, provider.props?.hrIcon);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: theme.base,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("hr", {
			ref,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/HR/HRSquare.js
var HRSquare = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		hrTheme.square,
		provider.theme?.hr?.square,
		props.theme
	], [get(provider.clearTheme, "hr.square"), props.clearTheme], [get(provider.applyTheme, "hr.square"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/HR/HRText.js
var HRText = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		hrTheme.text,
		provider.theme?.hr?.text,
		props.theme
	], [get(provider.clearTheme, "hr.text"), props.clearTheme], [get(provider.applyTheme, "hr.text"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/HR/HRTrimmed.js
var HRTrimmed = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		hrTheme.trimmed,
		provider.theme?.hr?.trimmed,
		props.theme
	], [get(provider.clearTheme, "hr.trimmed"), props.clearTheme], [get(provider.applyTheme, "hr.trimmed"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Kbd/theme.js
var kbdTheme = createTheme({ root: {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Kbd/Kbd.js
var Kbd = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		kbdTheme,
		provider.theme?.kbd,
		props.theme
	], [get(provider.clearTheme, "kbd"), props.clearTheme], [get(provider.applyTheme, "kbd"), props.applyTheme]);
...
Kbd.displayName = "Kbd";
//#endregion
//#region node_modules/flowbite-react/dist/components/Label/theme.js
var labelTheme = createTheme({ root: {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Label/Label.js
var Label = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		...
		props.theme
	], [get(provider.clearTheme, "label"), props.clearTheme], [get(provider.applyTheme, "label"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/List/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/List/List.js
var List = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		listTheme.root,
		provider.theme?.list?.root,
		props.theme
	], [get(provider.clearTheme, "list.root"), props.clearTheme], [get(provider.applyTheme, "list.root"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/List/ListItem.js
var ListItem = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		listTheme.item,
		provider.theme?.list?.item,
		props.theme
	], [get(provider.clearTheme, "list.item"), props.clearTheme], [get(provider.applyTheme, "list.item"), props.applyTheme]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
		...
		...restProps,
		children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: twMerge(theme.icon) }), children]
	});
});
ListItem.displayName = "ListItem";
//#endregion
//#region node_modules/flowbite-react/dist/components/ListGroup/theme.js
var listGroupTheme = createTheme({
	root: { base: "list-none rounded-lg border border-gray-200 bg-white text-left text-sm font-medium text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white" },
	item: {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/ListGroup/ListGroup.js
var ListGroup = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		listGroupTheme.root,
		provider.theme?.listGroup?.root,
		props.theme
	], [get(provider.clearTheme, "listGroup.root"), props.clearTheme], [get(provider.applyTheme, "listGroup.root"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/ListGroup/ListGroupItem.js
var ListGroupItem = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		listGroupTheme.item,
		provider.theme?.listGroup?.item,
		props.theme
	], [get(provider.clearTheme, "listGroup.item"), props.clearTheme], [get(provider.applyTheme, "listGroup.item"), props.applyTheme]);
	const { active: isActive, children, className, href, icon: Icon, onClick, disabled, ...restProps } = resolveProps(props, provider.props?.listGroupItem);
	const isLink = typeof href !== "undefined";
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Navbar/NavbarContext.js
var NavbarContext = (0, import_react.createContext)(void 0);
function useNavbarContext() {
	const context = (0, import_react.useContext)(NavbarContext);
	if (!context) throw new Error("useNavBarContext should be used within the NavbarContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Navbar/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Navbar/Navbar.js
var Navbar = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		navbarTheme,
		provider.theme?.navbar,
		props.theme
	], [get(provider.clearTheme, "navbar"), props.clearTheme], [get(provider.applyTheme, "navbar"), props.applyTheme]);
	const { border, children, className, fluid = false, menuOpen, rounded, ...restProps } = resolveProps(props, provider.props?.navbar);
	const [isOpen, setIsOpen] = (0, import_react.useState)(menuOpen);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavbarContext.Provider, {
		value: {
			theme: props.theme,
			clearTheme: props.clearTheme,
			applyTheme: props.applyTheme,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Navbar/NavbarBrand.js
var NavbarBrand = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		...
		get(provider.clearTheme, "navbar.brand"),
		get(rootClearTheme, "brand"),
		props.clearTheme
	], [
		get(provider.applyTheme, "navbar.brand"),
		get(rootApplyTheme, "brand"),
		props.applyTheme
	]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Navbar/NavbarCollapse.js
var NavbarCollapse = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		...
		get(provider.clearTheme, "navbar.collapse"),
		get(rootClearTheme, "collapse"),
		props.clearTheme
	], [
		get(provider.applyTheme, "navbar.collapse"),
		get(rootApplyTheme, "collapse"),
		props.applyTheme
	]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Navbar/NavbarLink.js
var NavbarLink = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		...
		get(provider.clearTheme, "navbar.link"),
		get(rootClearTheme, "link"),
		props.clearTheme
	], [
		get(provider.applyTheme, "navbar.link"),
		get(rootApplyTheme, "link"),
		props.applyTheme
	]);
	const { active, as: Component = "a", disabled, children, className, onClick, ...restProps } = resolveProps(props, provider.props?.navbarLink);
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/bars-icon.js
var BarsIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Navbar/NavbarToggle.js
var NavbarToggle = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, isOpen, setIsOpen } = useNavbarContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		navbarTheme.toggle,
		...
		get(provider.clearTheme, "navbar.toggle"),
		get(rootClearTheme, "toggle"),
		props.clearTheme
	], [
		get(provider.applyTheme, "navbar.toggle"),
		get(rootApplyTheme, "toggle"),
		props.applyTheme
	]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BarIcon, {
			"aria-hidden": true,
			className: theme.icon
		})]
	});
...
//#endregion
//#region node_modules/flowbite-react/dist/components/MegaMenu/theme.js
var megaMenuTheme = createTheme({
	...
	dropdownToggle: { base: twMerge(navbarTheme.link.base, navbarTheme.link.active.off, "flex w-full items-center justify-between") }
});
//#endregion
//#region node_modules/flowbite-react/dist/components/MegaMenu/MegaMenu.js
var MegaMenu = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navbar, {
		ref,
		theme: useResolveTheme([
			megaMenuTheme,
			provider.theme?.megaMenu,
			props.theme
		], [get(provider.clearTheme, "megaMenu"), props.clearTheme], [get(provider.applyTheme, "megaMenu"), props.applyTheme]),
		fluid: true,
		...resolveProps(props, provider.props?.megaMenu)
	});
});
MegaMenu.displayName = "MegaMenu";
//#endregion
//#region node_modules/flowbite-react/dist/components/MegaMenu/MegaMenuDropdown.js
function MegaMenuDropdown(props) {
	const [labelledBy, setLabelledBy] = (0, import_react.useState)(void 0);
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		megaMenuTheme.dropdown,
		provider.theme?.megaMenu?.dropdown,
		props.theme
	], [get(provider.clearTheme, "megaMenu.dropdown"), props.clearTheme], [get(provider.applyTheme, "megaMenu.dropdown"), props.applyTheme]);
	const { children, className, toggle, ...restProps } = resolveProps(props, provider.props?.megaMenuDropdown);
	if (toggle) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dropdown, {
		inline: true,
		label: toggle,
		placement: "bottom",
		theme: theme.toggle,
...
//#endregion
//#region node_modules/flowbite-react/dist/helpers/merge-refs.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/MegaMenu/MegaMenuDropdownToggle.js
var MegaMenuDropdownToggle = (0, import_react.forwardRef)((props, ref) => {
	const id = (0, import_react.useId)();
	const innerRef = (0, import_react.useRef)(null);
	const [controls, setControls] = (0, import_react.useState)(void 0);
	const [isExpanded, setExpanded] = (0, import_react.useState)(void 0);
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		megaMenuTheme.dropdownToggle,
		provider.theme?.megaMenu?.dropdownToggle,
		props.theme
	], [get(provider.clearTheme, "megaMenu.dropdownToggle"), props.clearTheme], [get(provider.applyTheme, "megaMenu.dropdownToggle"), props.applyTheme]);
	const { className, ...restProps } = resolveProps(props, provider.props?.megaMenuDropdownToggle);
	function findDropdown() {
		return (innerRef.current?.closest("nav"))?.querySelector("[role=\"menu\"]");
	}
	function onClick() {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Modal/ModalContext.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Modal/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Modal/Modal.js
var Modal = (0, import_react.forwardRef)((props, ref) => {
	const [headerId, setHeaderId] = (0, import_react.useState)(void 0);
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		modalTheme,
		provider.theme?.modal,
		props.theme
	], [get(provider.clearTheme, "modal"), props.clearTheme], [get(provider.applyTheme, "modal"), props.applyTheme]);
	const { children, className, dismissible = false, onClose, popup, position = "center", root, show, size = "2xl", initialFocus, ...restProps } = resolveProps(props, provider.props?.modal);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModalContext.Provider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingPortal, {
			root,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingOverlay, {
				lockScroll: true,
				...
				...restProps,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingFocusManager, {
					context,
					initialFocus,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						ref: mergedRef,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Modal/ModalBody.js
var ModalBody = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, popup } = useModalContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		modalTheme.body,
		provider.theme?.modal?.body,
		rootTheme?.body,
		props.theme
	], [
		get(provider.clearTheme, "modal.body"),
		get(rootClearTheme, "body"),
		props.clearTheme
	], [
		get(provider.applyTheme, "modal.body"),
		get(rootApplyTheme, "body"),
		props.applyTheme
	]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Modal/ModalFooter.js
var ModalFooter = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, popup } = useModalContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		modalTheme.footer,
		provider.theme?.modal?.footer,
		rootTheme?.footer,
		props.theme
	], [
		get(provider.clearTheme, "modal.footer"),
		get(rootClearTheme, "footer"),
		props.clearTheme
	], [
		get(provider.applyTheme, "modal.footer"),
		get(rootApplyTheme, "footer"),
		props.applyTheme
	]);
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/outline-x-icon.js
var OutlineXIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "none",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Modal/ModalHeader.js
var ModalHeader = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, popup, dismissible, onClose, setHeaderId } = useModalContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		modalTheme.header,
		provider.theme?.modal?.header,
		rootTheme?.header,
		props.theme
	], [
		get(provider.clearTheme, "modal.header"),
		get(rootClearTheme, "header"),
		props.clearTheme
	], [
		get(provider.applyTheme, "modal.header"),
		get(rootApplyTheme, "header"),
		props.applyTheme
	]);
	const { as: Component = "h3", children, className, id, ...restProps } = resolveProps(props, provider.props?.modalHeader);
	const innerHeaderId = (0, import_react.useId)();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, {
			...
			type: "button",
			onClick: onClose,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OutlineXIcon, {
				"aria-hidden": true,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Pagination/helpers.js
function range(start, end) {
	if (start >= end) return [];
	return [...Array(end - start + 1).keys()].map((key) => key + start);
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Pagination/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Pagination/PaginationButton.js
var PaginationButton = (0, import_react.forwardRef)(({ active, children, className, onClick, theme: customTheme, clearTheme, applyTheme, ...props }, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		paginationTheme,
		provider.theme?.pagination,
		customTheme
	], [get(provider.clearTheme, "pagination"), clearTheme], [get(provider.applyTheme, "pagination"), applyTheme]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		ref,
		type: "button",
...
function PaginationNavigation({ children, className, onClick, disabled = false, theme: customTheme, clearTheme, applyTheme, ...props }) {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		paginationTheme,
		provider.theme?.pagination,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Pagination/Pagination.js
var Pagination = (0, import_react.forwardRef)((props, ref) => {
	if (props.layout === "table") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TablePagination, {
		...props,
		ref
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DefaultPagination, {
		...props,
		ref
	});
});
var DefaultPagination = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		paginationTheme,
		provider.theme?.pagination,
		props.theme
	], [get(provider.clearTheme, "pagination"), props.clearTheme], [get(provider.applyTheme, "pagination"), props.applyTheme]);
	const { className, currentPage, layout = "pagination", nextLabel = "Next", onPageChange, previousLabel = "Previous", renderPaginationButton = (props2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaginationButton, { ...props2 }), totalPages, showIcons: showIcon = false, ...restProps } = resolveProps(props, provider.props?.pagination);
	if (!Number.isInteger(currentPage) || currentPage < 1) throw new Error("Invalid props: currentPage must be a positive integer");
	if (!Number.isInteger(totalPages) || totalPages < 1) throw new Error("Invalid props: totalPages must be a positive integer");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PaginationNavigation, {
					className: twMerge(theme.pages.previous.base, showIcon && theme.pages.showIcon),
					onClick: goToPreviousPage,
					disabled: currentPage === 1,
					children: [showIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeftIcon, {
						"aria-hidden": true,
						className: theme.pages.previous.icon
					}), previousLabel]
				}) }),
				layout === "pagination" && range(firstPage, lastPage).map((page) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PaginationNavigation, {
					...
					children: [nextLabel, showIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRightIcon, {
						"aria-hidden": true,
...
var TablePagination = (0, import_react.forwardRef)((props, ref) => {
	...
	const { className, currentPage, nextLabel = "Next", onPageChange, previousLabel = "Previous", showIcons: showIcon = false, itemsPerPage, totalItems, ...restProps } = resolveProps(props, provider.props?.pagination);
	if (!Number.isInteger(currentPage) || currentPage < 1) throw new Error("Invalid props: currentPage must be a positive integer");
	if (!Number.isInteger(itemsPerPage) || itemsPerPage < 1) throw new Error("Invalid props: itemsPerPage must be a positive integer");
	if (!Number.isInteger(totalItems) || totalItems < 0) throw new Error("Invalid props: totalItems must be a non-negative integer");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: theme.pages.base,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PaginationNavigation, {
				className: twMerge(theme.pages.previous.base, showIcon && theme.pages.showIcon),
				onClick: goToPreviousPage,
				disabled: currentPage === 1,
				children: [showIcon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeftIcon, {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Popover/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Popover/Popover.js
function Popover(props) {
	...
	const theme = useResolveTheme([
		...
		props.theme
	], [get(provider.clearTheme, "popover"), props.clearTheme], [get(provider.applyTheme, "popover"), props.applyTheme]);
	const { children, content, arrow = true, trigger = "click", initialOpen, open: controlledOpen, onOpenChange: setControlledOpen, placement: theirPlacement = "bottom", ...restProps } = resolveProps(props, provider.props?.popover);
	const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react.useState)(Boolean(initialOpen));
	const arrowRef = (0, import_react.useRef)(null);
	const open = controlledOpen ?? uncontrolledOpen;
	const { floatingStyles, context, placement, middlewareData: { arrow: { x: arrowX, y: arrowY } = {} }, refs } = useBaseFloating({
		open,
	...
	if (!(0, import_react.isValidElement)(children)) throw Error("Invalid target element");
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_react.useMemo)(() => {
		return (0, import_react.cloneElement)(children, getReferenceProps({
			ref,
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [arrow && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Progress/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Progress/Progress.js
var Progress = (0, import_react.forwardRef)((props, ref) => {
	const id = (0, import_react.useId)();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		progressTheme,
		provider.theme?.progress,
		props.theme
	], [get(provider.clearTheme, "progress"), props.clearTheme], [get(provider.applyTheme, "progress"), props.applyTheme]);
	const { className, color = "default", labelProgress = false, labelText = false, progress, progressLabelPosition = "inside", size = "md", textLabel = "progressbar", textLabelPosition = "inside", ...restProps } = resolveProps(props, provider.props?.progress);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref,
		id,
		...
		role: "progressbar",
		...restProps,
		children: [(textLabel && labelText && textLabelPosition === "outside" || progress > 0 && labelProgress && progressLabelPosition === "outside") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: theme.label,
			"data-testid": "flowbite-progress-outer-label-container",
			children: [textLabel && labelText && textLabelPosition === "outside" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				"data-testid": "flowbite-progress-outer-text-label",
				children: textLabel
			}), labelProgress && progressLabelPosition === "outside" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				"data-testid": "flowbite-progress-outer-progress-label",
				children: [progress, "%"]
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: twMerge(theme.base, theme.size[size], className),
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: { width: `${progress}%` },
				className: twMerge(theme.bar, theme.color[color], theme.size[size]),
				children: [textLabel && labelText && textLabelPosition === "inside" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					"data-testid": "flowbite-progress-inner-text-label",
					children: textLabel
				}), progress > 0 && labelProgress && progressLabelPosition === "inside" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Radio/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Radio/Radio.js
var Radio = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		radioTheme,
		provider.theme?.radio,
		props.theme
	], [get(provider.clearTheme, "radio"), props.clearTheme], [get(provider.applyTheme, "radio"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/RangeSlider/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/RangeSlider/RangeSlider.js
var RangeSlider = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		rangeSliderTheme,
		provider.theme?.rangeSlider,
		props.theme
	], [get(provider.clearTheme, "rangeSlider"), props.clearTheme], [get(provider.applyTheme, "rangeSlider"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Rating/RatingContext.js
var RatingContext = (0, import_react.createContext)(void 0);
function useRatingContext() {
	const context = (0, import_react.useContext)(RatingContext);
	if (!context) throw new Error("useRatingContext should be used within the RatingContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Rating/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Rating/Rating.js
var Rating = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		ratingTheme,
		provider.theme?.rating,
		props.theme
	], [get(provider.clearTheme, "rating"), props.clearTheme], [get(provider.applyTheme, "rating"), props.applyTheme]);
	const { className, size = "sm", ...restProps } = resolveProps(props, provider.props?.rating);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RatingContext.Provider, {
		value: {
			theme: props.theme,
			clearTheme: props.clearTheme,
			applyTheme: props.applyTheme,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Rating/RatingAdvanced.js
var RatingAdvanced = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		ratingAdvancedTheme,
		provider.theme?.ratingAdvanced,
		props.theme
	], [get(provider.clearTheme, "ratingAdvanced"), props.clearTheme], [get(provider.applyTheme, "ratingAdvanced"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/icons/star-icon.js
var StarIcon = (0, import_react.forwardRef)((props, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	width: "1em",
	height: "1em",
	fill: "currentColor",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Rating/RatingStar.js
var RatingStar = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, size = "sm" } = useRatingContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		ratingTheme.star,
		provider.theme?.rating?.star,
		rootTheme?.star,
		props.theme
	], [
		get(provider.clearTheme, "rating.star"),
		get(rootClearTheme, "star"),
		props.clearTheme
	], [
		get(provider.applyTheme, "rating.star"),
		get(rootApplyTheme, "star"),
		props.applyTheme
	]);
	const { className, filled = true, starIcon: Icon = StarIcon, ...restProps } = resolveProps(props, provider.props?.ratingStar);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Select/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Select/Select.js
var Select = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		selectTheme,
		provider.theme?.select,
		props.theme
	], [get(provider.clearTheme, "select"), props.clearTheme], [get(provider.applyTheme, "select"), props.applyTheme]);
	const { addon, className, color = "gray", icon: Icon, shadow, sizing = "md", ...restProps } = resolveProps(props, provider.props?.select);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: twMerge(theme.base, className),
		children: [addon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: theme.addon,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/SidebarContext.js
var SidebarContext = (0, import_react.createContext)(void 0);
function useSidebarContext() {
	const context = (0, import_react.useContext)(SidebarContext);
	if (!context) throw new Error("useSidebarContext should be used within the SidebarContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/Sidebar.js
var Sidebar = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		sidebarTheme,
		provider.theme?.sidebar,
		props.theme
	], [get(provider.clearTheme, "sidebar"), props.clearTheme], [get(provider.applyTheme, "sidebar"), props.applyTheme]);
	const { as: Component = "nav", children, className, collapseBehavior = "collapse", collapsed: isCollapsed = false, ...restProps } = resolveProps(props, provider.props?.sidebar);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/SidebarItemContext.js
var SidebarItemContext = (0, import_react.createContext)(void 0);
function useSidebarItemContext() {
	const context = (0, import_react.useContext)(SidebarItemContext);
	if (!context) throw new Error("useSidebarItemContext should be used within the SidebarItemContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/SidebarCollapse.js
var SidebarCollapse = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, isCollapsed } = useSidebarContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		sidebarTheme.collapse,
		provider.theme?.sidebar?.collapse,
		rootTheme?.collapse,
		props.theme
	], [
		get(provider.clearTheme, "sidebar.collapse"),
		get(rootClearTheme, "collapse"),
		props.clearTheme
	], [
		get(provider.applyTheme, "sidebar.collapse"),
		get(rootApplyTheme, "collapse"),
		props.applyTheme
	]);
	const { children, className, icon: Icon, label, chevronIcon: ChevronIcon = ChevronDownIcon, renderChevronIcon, open = false, ...restProps } = resolveProps(props, provider.props?.sidebarCollapse);
	const id = (0, import_react.useId)();
	const [isOpen, setOpen] = (0, import_react.useState)(open);
	(0, import_react.useEffect)(() => setOpen(open), [open]);
	function Wrapper({ children: children2 }) {
		if (isCollapsed && !isOpen) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tooltip, {
			content: label,
			placement: "right",
			children: children2
		});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		ref,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Wrapper, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, {
				...
				className: theme.label.base,
				children: label
			}), renderChevronIcon ? renderChevronIcon(theme, isOpen) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronIcon, {
				"aria-hidden": true,
			...
			hidden: !isOpen,
			className: theme.list,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarItemContext.Provider, {
				value: { isInsideCollapse: true },
				children
			})
		})] })
	});
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/SidebarCTA.js
var SidebarCTA = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, isCollapsed } = useSidebarContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		sidebarTheme.cta,
		provider.theme?.sidebar?.cta,
		rootTheme?.cta,
		props.theme
	], [
		get(provider.clearTheme, "sidebar.cta"),
		get(rootClearTheme, "cta"),
		props.clearTheme
	], [
		get(provider.applyTheme, "sidebar.cta"),
		get(rootApplyTheme, "cta"),
		props.applyTheme
	]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/SidebarItem.js
var SidebarItem = (0, import_react.forwardRef)((props, ref) => {
	const id = (0, import_react.useId)();
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, isCollapsed } = useSidebarContext();
	...
	const theme = useResolveTheme([
		...
		get(provider.clearTheme, "sidebar.item"),
		get(rootClearTheme, "item"),
		props.clearTheme
	], [
		get(provider.applyTheme, "sidebar.item"),
		get(rootApplyTheme, "item"),
		props.applyTheme
	]);
	const { active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", ...restProps } = resolveProps(props, provider.props?.sidebarItem);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListItem$1, {
		theme,
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, {
			...
			children: [
				...
				isCollapsed && !Icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: theme.collapsed.noIcon,
					children: children.charAt(0).toLocaleUpperCase() ?? "?"
				}),
				!isCollapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Children$1, {
					id,
					theme,
					children
				}),
				!isCollapsed && label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
					color: labelColor,
...
function ListItem$1({ id, theme, isCollapsed, tooltipChildren, children: wrapperChildren, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
		...props,
		children: isCollapsed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tooltip, {
			content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Children$1, {
				id,
				theme,
...
ListItem$1.displayName = "SidebarItem.ListItem";
function Children$1({ id, theme, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
ListItem$1.displayName = "SidebarItem.Children";
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/SidebarItemGroup.js
var SidebarItemGroup = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useSidebarContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		sidebarTheme.itemGroup,
		provider.theme?.sidebar?.itemGroup,
		rootTheme?.itemGroup,
		props.theme
	], [
		get(provider.clearTheme, "sidebar.itemGroup"),
		get(rootClearTheme, "itemGroup"),
		props.clearTheme
	], [
		get(provider.applyTheme, "sidebar.itemGroup"),
		get(rootApplyTheme, "itemGroup"),
		props.applyTheme
	]);
	const { className, ...restProps } = resolveProps(props, provider.props?.sidebarItemGroup);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarItemContext.Provider, {
		value: { isInsideCollapse: false },
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			ref,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/SidebarItems.js
var SidebarItems = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useSidebarContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		sidebarTheme.items,
		...
		get(provider.clearTheme, "sidebar.items"),
		get(rootClearTheme, "items"),
		props.clearTheme
	], [
		get(provider.applyTheme, "sidebar.items"),
		get(rootApplyTheme, "items"),
		props.applyTheme
	]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Sidebar/SidebarLogo.js
var SidebarLogo = (0, import_react.forwardRef)((props, ref) => {
	const id = (0, import_react.useId)();
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, isCollapsed } = useSidebarContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		sidebarTheme.logo,
		provider.theme?.sidebar?.logo,
		rootTheme?.logo,
		props.theme
	], [
		get(provider.clearTheme, "sidebar.logo"),
		get(rootClearTheme, "logo"),
		props.clearTheme
	], [
		get(provider.applyTheme, "sidebar.logo"),
		get(rootApplyTheme, "logo"),
		props.applyTheme
	]);
	const { children, className, href, img, imgAlt = "", ...restProps } = resolveProps(props, provider.props?.sidebarLogo);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
		ref,
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Spinner/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Spinner/Spinner.js
var Spinner = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		spinnerTheme,
		provider.theme?.spinner,
		props.theme
	], [get(provider.clearTheme, "spinner"), props.clearTheme], [get(provider.applyTheme, "spinner"), props.applyTheme]);
	const { className, color = "default", light, size = "lg", ...restProps } = resolveProps(props, provider.props?.spinner);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		ref,
		role: "status",
		...restProps,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			fill: "none",
			viewBox: "0 0 100 101",
			className: twMerge(theme.base, theme.color[color], theme.light[light ? "on" : "off"].base, theme.light[light ? "on" : "off"].color[color], theme.size[size], className),
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/TableContext.js
var TableContext = (0, import_react.createContext)(void 0);
function useTableContext() {
	const context = (0, import_react.useContext)(TableContext);
	if (!context) throw new Error("useTableContext should be used within the TableContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/theme.js
var tableTheme = createTheme({
	...
	body: {
		base: "group/body",
		cell: { base: "px-6 py-4 group-first/body:group-first/row:first:rounded-tl-lg group-first/body:group-first/row:last:rounded-tr-lg group-last/body:group-last/row:first:rounded-bl-lg group-last/body:group-last/row:last:rounded-br-lg" }
	},
	head: {
		base: "group/head text-xs uppercase text-gray-700 dark:text-gray-400",
		cell: { base: "bg-gray-50 px-6 py-3 group-first/head:first:rounded-tl-lg group-first/head:last:rounded-tr-lg dark:bg-gray-700" }
	},
	row: {
		base: "group/row",
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/Table.js
var Table = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		tableTheme,
		provider.theme?.table,
		props.theme
	], [get(provider.clearTheme, "table"), props.clearTheme], [get(provider.applyTheme, "table"), props.applyTheme]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableContext.Provider, {
			value: {
				theme: props.theme,
				clearTheme: props.clearTheme,
				applyTheme: props.applyTheme,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: twMerge(theme.root.shadow, className) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("table", {
				ref,
				className: twMerge(theme.root.base, className),
				...restProps
			})]
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/TableBodyContext.js
var TableBodyContext = (0, import_react.createContext)(void 0);
function useTableBodyContext() {
	const context = (0, import_react.useContext)(TableBodyContext);
	if (!context) throw new Error("useTableBodyContext should be used within the TableBodyContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/TableBody.js
var TableBody = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		tableTheme.body,
		provider.theme?.table?.body,
		rootTheme?.body,
		props.theme
	], [
		get(provider.clearTheme, "table.body"),
		get(rootClearTheme, "body"),
		props.clearTheme
	], [
		get(provider.applyTheme, "table.body"),
		get(rootApplyTheme, "body"),
		props.applyTheme
	]);
	const { className, ...restProps } = resolveProps(props, provider.props?.tableBody);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBodyContext.Provider, {
		value: {
			theme: props.theme,
			clearTheme: props.clearTheme,
			applyTheme: props.applyTheme
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/TableCell.js
var TableCell = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useTableContext();
	const { theme: bodyTheme, clearTheme: bodyClearTheme, applyTheme: bodyApplyTheme } = useTableBodyContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		tableTheme.body.cell,
		provider.theme?.table?.body?.cell,
		rootTheme?.body?.cell,
		bodyTheme?.cell,
		props.theme
	], [
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/TableHeadContext.js
var TableHeadContext = (0, import_react.createContext)(void 0);
function useTableHeadContext() {
	const context = (0, import_react.useContext)(TableHeadContext);
	if (!context) throw new Error("useTableHeadContext should be used within the TableHeadContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/TableHead.js
var TableHead = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useTableContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		tableTheme.head,
		provider.theme?.table?.head,
		rootTheme?.head,
		props.theme
	], [
		get(provider.clearTheme, "table.head"),
		get(rootClearTheme, "head"),
		props.clearTheme
	], [
		get(provider.applyTheme, "table.head"),
		get(rootApplyTheme, "head"),
		props.applyTheme
	]);
	const { className, ...restProps } = resolveProps(props, provider.props?.tableHead);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeadContext.Provider, {
		value: {
			theme: props.theme,
			clearTheme: props.clearTheme,
			applyTheme: props.applyTheme
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/TableHeadCell.js
var TableHeadCell = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useTableContext();
	const { theme: headTheme, clearTheme: headClearTheme, applyTheme: headApplyTheme } = useTableHeadContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		tableTheme.head.cell,
		provider.theme?.table?.head?.cell,
		rootTheme?.head?.cell,
		headTheme?.cell,
		props.theme
	], [
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Table/TableRow.js
var TableRow = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, hoverable, striped } = useTableContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		tableTheme.row,
		provider.theme?.table?.row,
		rootTheme?.row,
		props.theme
	], [
		get(provider.clearTheme, "table.row"),
		get(rootClearTheme, "row"),
		props.clearTheme
	], [
		get(provider.applyTheme, "table.row"),
		get(rootApplyTheme, "row"),
		props.applyTheme
	]);
...
//#endregion
//#region node_modules/flowbite-react/dist/store/init/client.js
...
//#endregion
//#region node_modules/flowbite-react/dist/store/init/server.js
...
//#endregion
//#region node_modules/flowbite-react/dist/store/init/index.js
function StoreInit(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StoreInitServer, { ...props }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StoreInitClient, { ...props })] });
}
StoreInit.displayName = "StoreInit";
//#endregion
//#region node_modules/flowbite-react/dist/theme/config.js
function ThemeConfig({ mode }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StoreInit, { mode });
}
ThemeConfig.displayName = "ThemeConfig";
//#endregion
//#region node_modules/flowbite-react/dist/theme/mode-script.js
var defaultOptions = {
	defaultMode: "auto",
...
function initThemeMode(props = {}) {
	...
	try {
		const storageMode = window.localStorage.getItem(localStorageKey);
		const resolvedMode = (storageMode === "light" || storageMode === "dark" || storageMode === "auto" ? storageMode : null) ?? mode ?? defaultMode;
		...
		window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", (e) => {
			...
			if ((storageMode2 === "light" || storageMode2 === "dark" || storageMode2 === "auto" ? storageMode2 : defaultMode) === "auto") if (e.matches) document.documentElement.classList.add(className);
			else document.documentElement.classList.remove(className);
		});
		window.addEventListener("storage", (e) => {
			if (e.key === localStorageKey) {
				const newMode = e.newValue;
				const resolvedMode2 = newMode === "light" || newMode === "dark" || newMode === "auto" ? newMode : defaultMode;
				if (resolvedMode2 === "dark" || resolvedMode2 === "auto" && window.matchMedia("(prefers-color-scheme: dark)").matches) document.documentElement.classList.add(className);
				else document.documentElement.classList.remove(className);
			}
		});
	} catch (e) {}
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Tabs/TabItem.js
var TabItem = (0, import_react.forwardRef)((props, ref) => {
	const { title: _, ...restProps } = resolveProps(props, useThemeProvider().props?.tabItem);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref,
		...restProps
	});
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Tabs/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Tabs/Tabs.js
var Tabs = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		tabsTheme,
		provider.theme?.tabs,
		props.theme
	], [get(provider.clearTheme, "tabs"), props.clearTheme], [get(provider.applyTheme, "tabs"), props.applyTheme]);
	const { children, className, onActiveTabChange, variant = "default", ...restProps } = resolveProps(props, provider.props?.tabs);
	const id = (0, import_react.useId)();
	const tabs = (0, import_react.useMemo)(() => import_react.Children.map(import_react.Children.toArray(children), ({ props: props2 }) => props2), [children]);
	const tabRefs = (0, import_react.useRef)([]);
	const [activeTab, setActiveTab] = (0, import_react.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
	const [focusedTab, setFocusedTab] = (0, import_react.useState)(-1);
	...
	function handleKeyboard({ event, target }) {
		if (event.key === "ArrowLeft") setFocusedTab(Math.max(0, focusedTab - 1));
		if (event.key === "ArrowRight") setFocusedTab(Math.min(tabs.length - 1, focusedTab + 1));
		if (event.key === "Enter") {
			setActiveTabWithCallback(target);
			setFocusedTab(target);
		}
	...
	(0, import_react.useImperativeHandle)(ref, () => ({ setActiveTab: setActiveTabWithCallback }));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: twMerge(theme.base, className),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			"aria-label": "Tabs",
			...
			...restProps,
			children: tabs.map((tab, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				...
				children: [tab.icon && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(tab.icon, { className: theme.tablist.tabitem.icon }), tab.title]
			}, index))
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: twMerge(theme.tabitemcontainer.base, tabItemContainerStyle),
			children: tabs.map((tab, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Textarea/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Textarea/Textarea.js
var Textarea = (0, import_react.forwardRef)((props, ref) => {
	...
	const theme = useResolveTheme([
		...
		props.theme
	], [get(provider.clearTheme, "textarea"), props.clearTheme], [get(provider.applyTheme, "textarea"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelineContext.js
var TimelineContext = (0, import_react.createContext)(void 0);
function useTimelineContext() {
	const context = (0, import_react.useContext)(TimelineContext);
	if (!context) throw new Error("useTimelineContext should be used within the TimelineContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/Timeline.js
var Timeline = (0, import_react.forwardRef)((props, ref) => {
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		timelineTheme,
		provider.theme?.timeline,
		props.theme
	], [get(provider.clearTheme, "timeline"), props.clearTheme], [get(provider.applyTheme, "timeline"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelineContentContext.js
var TimelineContentContext = (0, import_react.createContext)(void 0);
function useTimelineContentContext() {
	const context = (0, import_react.useContext)(TimelineContentContext);
	if (!context) throw new Error("useTimelineContentContext should be used within the TimelineContentContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelineItemContext.js
...
function useTimelineItemContext() {
	...
	if (!context) throw new Error("useTimelineItemContext should be used within the TimelineItemContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelineBody.js
var TimelineBody = (0, import_react.forwardRef)((props, ref) => {
	...
	const { theme: contentTheme, clearTheme: contentClearTheme, applyTheme: contentApplyTheme } = useTimelineContentContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelineContent.js
var TimelineContent = (0, import_react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TimelineContentContext.Provider, {
		value: {
			theme: props.theme,
			clearTheme: props.clearTheme,
			applyTheme: props.applyTheme
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelineItem.js
var TimelineItem = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, horizontal } = useTimelineContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		timelineTheme.item,
		provider.theme?.timeline?.item,
		rootTheme?.item,
		props.theme
	], [
		get(provider.clearTheme, "timeline.item"),
		get(rootClearTheme, "item"),
		props.clearTheme
	], [
		get(provider.applyTheme, "timeline.item"),
		get(rootApplyTheme, "item"),
		props.applyTheme
	]);
	const { className, ...restProps } = resolveProps(props, provider.props?.timelineItem);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TimelineItemContext.Provider, {
		value: {
			theme: props.theme,
			clearTheme: props.clearTheme,
			applyTheme: props.applyTheme
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelinePoint.js
var TimelinePoint = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, horizontal } = useTimelineContext();
	const { theme: itemTheme, clearTheme: itemClearTheme, applyTheme: itemApplyTheme } = useTimelineItemContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: twMerge(horizontal && theme.marker.base.horizontal, !horizontal && theme.marker.base.vertical) }),
			horizontal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: twMerge(theme.line) })
		]
	});
});
TimelinePoint.displayName = "TimelinePoint";
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelineTime.js
var TimelineTime = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useTimelineContext();
	const { theme: itemTheme, clearTheme: itemClearTheme, applyTheme: itemApplyTheme } = useTimelineItemContext();
	const { theme: contentTheme, clearTheme: contentClearTheme, applyTheme: contentApplyTheme } = useTimelineContentContext();
	const provider = useThemeProvider();
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Timeline/TimelineTitle.js
var TimelineTitle = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme } = useTimelineContext();
	const { theme: itemTheme, clearTheme: itemClearTheme, applyTheme: itemApplyTheme } = useTimelineItemContext();
	const { theme: contentTheme, clearTheme: contentClearTheme, applyTheme: contentApplyTheme } = useTimelineContentContext();
	const provider = useThemeProvider();
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Toast/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Toast/ToastContext.js
var ToastContext = (0, import_react.createContext)(void 0);
function useToastContext() {
	const context = (0, import_react.useContext)(ToastContext);
	if (!context) throw new Error("useToastContext should be used within the ToastContext provider!");
	return context;
}
//#endregion
//#region node_modules/flowbite-react/dist/components/Toast/Toast.js
var durationClasses = {
	75: "duration-75",
	100: "duration-100",
	150: "duration-150",
...
var Toast = (0, import_react.forwardRef)((props, ref) => {
	const [isClosed, setIsClosed] = (0, import_react.useState)(false);
	const [isRemoved, setIsRemoved] = (0, import_react.useState)(false);
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		toastTheme,
		provider.theme?.toast,
		props.theme
	], [get(provider.clearTheme, "toast"), props.clearTheme], [get(provider.applyTheme, "toast"), props.applyTheme]);
...
//#endregion
//#region node_modules/flowbite-react/dist/components/Toast/ToastToggle.js
var ToastToggle = (0, import_react.forwardRef)((props, ref) => {
	const { theme: rootTheme, clearTheme: rootClearTheme, applyTheme: rootApplyTheme, duration, isClosed, isRemoved, setIsClosed, setIsRemoved } = useToastContext();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		toastTheme.toggle,
		provider.theme?.toast?.toggle,
		rootTheme?.toggle,
		props.theme
	], [
		get(provider.clearTheme, "toast.toggle"),
		get(rootClearTheme, "toggle"),
		props.clearTheme
	], [
		get(provider.applyTheme, "toast.toggle"),
		get(rootApplyTheme, "toggle"),
		props.applyTheme
	]);
	const { className, onClick, onDismiss, xIcon: XIcon$1 = XIcon, ...restProps } = resolveProps(props, provider.props?.toastToggle);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		className: twMerge(theme.base, className),
		...restProps,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XIcon$1, {
			"aria-hidden": true,
			className: theme.icon
		})
	});
...
//#endregion
//#region node_modules/flowbite-react/dist/components/ToggleSwitch/theme.js
...
//#endregion
//#region node_modules/flowbite-react/dist/components/ToggleSwitch/ToggleSwitch.js
var ToggleSwitch = (0, import_react.forwardRef)((props, ref) => {
	const id = (0, import_react.useId)();
	const provider = useThemeProvider();
	const theme = useResolveTheme([
		toggleSwitchTheme,
		provider.theme?.toggleSwitch,
		props.theme
	], [get(provider.clearTheme, "toggleSwitch"), props.clearTheme], [get(provider.applyTheme, "toggleSwitch"), props.applyTheme]);
	const { checked, className, color = "default", sizing = "md", disabled, label, name, onChange, ...restProps } = resolveProps(props, provider.props?.toggleSwitch);
	function handleClick() {
		onChange(!checked);
	}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		...
		}), !!label?.length && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
//#endregion
//#region node_modules/flowbite-react/dist/theme/index.js
var theme = {
...
//#endregion
export { Accordion, AccordionContent, AccordionPanel, AccordionPanelContext, AccordionTitle, Alert, ArrowLeftIcon, ArrowRightIcon, Avatar, AvatarGroup, AvatarGroupCounter, Badge, Banner, BannerCollapseButton, BarsIcon, Blockquote, Breadcrumb, BreadcrumbItem, Button, ButtonGroup, ButtonGroupContext, CalendarIcon, Card, Carousel, CheckIcon, Checkbox, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, Clipboard, ClipboardListIcon, ClipboardWithIcon, ClipboardWithIconText, CloseIcon, DarkThemeToggle, Datepicker, DatepickerContext, Drawer, DrawerContext, DrawerHeader, DrawerItems, Dropdown, DropdownContext, DropdownDivider, DropdownHeader, DropdownItem, FileInput, FloatingLabel, Footer, FooterBrand, FooterCopyright, FooterDivider, FooterIcon, FooterLink, FooterLinkGroup, FooterTitle, HR, HRIcon, HRSquare, HRText, HRTrimmed, HelperText, HomeIcon, Kbd, Label, List, ListGroup, ListGroupItem, ListItem, MegaMenu, MegaMenuDropdown, MegaMenuDropdownToggle, Modal, ModalBody, ModalContext, ModalFooter, ModalHeader, MoonIcon, Navbar, NavbarBrand, NavbarCollapse, NavbarContext, NavbarLink, NavbarToggle, OutlineXIcon, Pagination, PaginationButton, Popover, Progress, QuoteRightIcon, Radio, RangeSlider, Rating, RatingAdvanced, RatingContext, RatingStar, Select, Sidebar, SidebarCTA, SidebarCollapse, SidebarContext, SidebarItem, SidebarItemContext, SidebarItemGroup, SidebarItems, SidebarLogo, Spinner, StarIcon, SunIcon, TabItem, Table, TableBody, TableBodyContext, TableCell, TableContext, TableHead, TableHeadCell, TableHeadContext, TableRow, Tabs, TextInput, Textarea, ThemeConfig, ThemeModeScript, ThemeProvider, Timeline, TimelineBody, TimelineContent, TimelineContentContext, TimelineContext, TimelineItem, TimelineItemContext, TimelinePoint, TimelineTime, TimelineTitle, Toast, ToastContext, ToastToggle, ToggleSwitch, Tooltip, Views, WeekStart, XIcon, accordionTheme, alertTheme, avatarTheme, badgeTheme, bannerTheme, blockquoteTheme, breadcrumbTheme, buttonGroupTheme, buttonTheme, cardTheme, carouselTheme, checkboxTheme, clipboardTheme, createTheme, darkThemeToggleTheme, datePickerTheme, drawerTheme, dropdownTheme, fileInputTheme, floatingLabelTheme, footerTheme, getFirstDateInRange, getThemeModeScript, helperTextTheme, hrTheme, initThemeMode, kbdTheme, labelTheme, listGroupTheme, listTheme, megaMenuTheme, modalTheme, navbarTheme, paginationTheme, popoverTheme, progressTheme, radioTheme, rangeSliderTheme, ratingAdvancedTheme, ratingTheme, selectTheme, sidebarTheme, spinnerTheme, tableTheme, tabsTheme, textInputTheme, textareaTheme, theme, timelineTheme, toastTheme, toggleSwitchTheme, tooltipTheme, useAccordionContext, useButtonGroupContext, useDatePickerContext, useDrawerContext, useDropdownContext, useModalContext, useNavbarContext, useRatingContext, useSidebarContext, useSidebarItemContext, useTableBodyContext, useTableContext, useTableHeadContext, useThemeMode, useThemeProvider, useTimelineContentContext, useTimelineContext, useTimelineItemContext, useToastContext };
