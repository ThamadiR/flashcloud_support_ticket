...
import { F as isSupportedCountry$1, L as metadata_min_json_default, M as Metadata, N as getCountryCallingCode$1, a as isPossiblePhoneNumber$1, d as parseIncompletePhoneNumber, f as parsePhoneNumberCharacter, n as getCountries$1, o as isValidPhoneNumber$1, r as AsYouType, s as parsePhoneNumber$2, t as formatIncompletePhoneNumber } from "./formatIncompletePhoneNumber-CcPRcnxY.js";
...
function count_occurences(symbol, string) {
	var count = 0;
	for (var _iterator = _createForOfIteratorHelperLoose$4(string.split("")), _step; !(_step = _iterator()).done;) if (_step.value === symbol) count++;
	return count;
}
//#endregion
...
function templateFormatter_default(template) {
	...
	return function(value) {
		...
		for (var _iterator = _createForOfIteratorHelperLoose$3(template.split("")), _step; !(_step = _iterator()).done;) {
...
function formatInputText(input, _parse, _format, operation, on_change) {
	var _parse2 = parse(input.value, getCaretPosition$1(input), _parse), value = _parse2.value, caret = _parse2.caret;
	if (operation) {
...
function useInput(_ref) {
	...
	var commonProps = _objectSpread$3(_objectSpread$3({}, rest), {}, {
		ref: setRef,
		onChange: _onChange,
		onKeyDown: _onKeyDown
	});
	if (controlled) return _objectSpread$3(_objectSpread$3({}, commonProps), {}, { value: format(isEmptyValue(value) ? "" : value).text });
	return _objectSpread$3(_objectSpread$3({}, commonProps), {}, { defaultValue: format(isEmptyValue(defaultValue) ? "" : defaultValue).text });
}
...
function Input(_ref, ref) {
	...
	var inputProps = useInput(_objectSpread$2({
		ref,
		parse,
		format,
		value,
